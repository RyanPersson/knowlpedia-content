...
Equivalently, the {{< knowl id="jacobian-matrix" text="Jacobian matrix" >}} $JF(a)$ has rank $m$ (full row rank). Regular points are the local nondegeneracy condition used in the {{< knowl id="implicit-function-theorem" text="implicit function theorem" >}} and in the definition of a {{< knowl id="regular-value" text="regular value" >}}.
