...
Constraint sets are central in constrained optimization (see {{< knowl id="lagrange-multipliers-theorem" text="Lagrange multipliers" >}}). When $c$ is a {{< knowl id="regular-value" text="regular value" >}} of $g$, the constraint set typically has good local structure and is a natural domain for an {{< knowl id="implicitly-defined-function" text="implicitly defined function" >}}.
