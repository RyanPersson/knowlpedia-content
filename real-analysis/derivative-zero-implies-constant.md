...
description: "If the derivative of a differentiable function is zero everywhere on an interval, the function is constant."
---

**Derivative zero implies constant:** Let $I\subseteq\mathbb{R}$ be an {{< knowl id="interval" text="interval" >}}, and let $f:I\to\mathbb{R}$ be {{< knowl id="differentiability-1d" text="differentiable" >}} on $I$. If
$$
