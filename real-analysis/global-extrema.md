...
description: "A continuous real function on a compact set attains its maximum and minimum."
---

**Global extrema:** Let $K\subseteq\mathbb R^n$ be nonempty and compact, and let $f:K\to\mathbb R$ be {{< knowl id="continuous-map" section="topology" text="continuous" >}}. Then there exist points $x_{\min},x_{\max}\in K$ such that
$$
