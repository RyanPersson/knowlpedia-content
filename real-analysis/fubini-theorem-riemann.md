...
**Fubini theorem (Riemann):** Let $a<b$ and $c<d$, and let $f:[a,b]\times[c,d]\to\mathbb{R}$ be continuous. Then $f$ is {{< knowl id="multiple-riemann-integral" text="Riemann integrable on the rectangle" >}}, the two {{< knowl id="iterated-integral" text="iterated integrals" >}} exist, and
$$
