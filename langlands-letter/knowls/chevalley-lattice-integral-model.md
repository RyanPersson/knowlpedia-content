...
For a prime $p$, base change gives a group scheme $G_{\mathbb{Z}_p}$ and a canonical compact subgroup $G(\mathbb{Z}_p)$ (hyperspecial when $p$ is good; see {{< knowl id="maximal-compact-hyperspecial" section="langlands-letter/knowls" text="hyperspecial" >}}).
