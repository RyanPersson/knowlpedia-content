...
Via {{< knowl id="spherical-hecke-algebra-satake" section="langlands-letter/knowls" text="Satake" >}}, $\chi_p$ determines the conjugacy class $\alpha_p$ used in the Euler product.
