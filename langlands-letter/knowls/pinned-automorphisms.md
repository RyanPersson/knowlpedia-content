...
In the letter, $\Omega$ is a group of such "pinning-preserving" automorphisms (with lattice conditions), and its contragredient action gives an action on the {{< knowl id="langlands-dual-group" section="langlands-letter/knowls" text="dual group" >}}.
