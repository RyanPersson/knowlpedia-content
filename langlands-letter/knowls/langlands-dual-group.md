...
- Unramified Hecke eigencharacters correspond to semisimple conjugacy classes in $\widehat G$ (more precisely in the {{< knowl id="l-group-satake-parameter" section="langlands-letter/knowls" text="$L$-group" >}}).
