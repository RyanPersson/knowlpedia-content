...
- Between topological spaces: a {{< knowl id="continuity-on-a-set" section="real-analysis" text="continuous map" >}} preserves the property of being open (via preimages).
