...
Injectivity means that outputs uniquely determine inputs (within the {{< knowl id="domain" section="shared-foundations" text="domain" >}}). This is the exact condition needed for a (two-sided) {{< knowl id="inverse-function" text="inverse function" >}} to exist after restricting the {{< knowl id="codomain" section="shared-foundations" text="codomain" >}} to the {{< knowl id="image-range" text="image" >}}.
