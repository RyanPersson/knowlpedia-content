...
Let $f:X\to Y$ be {{< knowl id="bijective-function" section="shared-foundations" text="bijective" >}}. The **inverse function** of $f$ is the {{< knowl id="function-map" text="function" >}} $f^{-1}:Y\to X$ defined by
