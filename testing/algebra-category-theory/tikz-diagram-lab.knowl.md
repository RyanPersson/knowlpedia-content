+++
id = "algebra-category-theory/tikz-diagram-lab"
title = "TikZ diagram lab: category theory lecture notes"
kind = "knowl"
summary = "A diagram-heavy category theory note for practicing TikZ, tikz-cd, and compiler rendering behavior."
...
diagrams. The mathematical content is intentionally compact; the main point is to exercise the renderer on
commutative diagrams, universal properties,
[[algebra-category-theory/adjoint-functors|adjunction]] triangles, and string-like
[[algebra-category-theory/composition-category|composition]] pictures.

## 1. A category as composable arrows

A category has [[algebra-category-theory/object|objects]],
[[algebra-category-theory/morphism|morphisms]],
[[algebra-category-theory/identity-morphism|identities]], and associative composition.
In a small local picture, the equality \(h = g \circ f\) is represented by the
...
A [[algebra-category-theory/functor|functor]] \(F : \mathcal{C} \to \mathcal{D}\) sends objects to objects and
...
For functors \(F,G : \mathcal{C}\to\mathcal{D}\), a [[algebra-category-theory/natural-transformation|natural transformation]]
...
A [[algebra-category-theory/pullback|pullback]] of \(f : X\to Z\) and \(g : Y\to Z\) is an object \(P\) equipped
with projections such that every compatible [[algebra-category-theory/limit|cone]] factors uniquely through \(P\).
...
\]
The [[algebra-category-theory/unit-adjunction|unit]] and
[[algebra-category-theory/counit-adjunction|counit]] satisfy the triangle identities:
...
The [[algebra-category-theory/yoneda-embedding|Yoneda embedding]] sends an object \(A\) to the
...
One way to remember the [[algebra-category-theory/yoneda-lemma|Yoneda lemma]] is that every natural transformation out of a
...
These smaller knowls mix prose, LaTeX display math, and TikZ diagrams so the
runtime can be checked on nested knowl content:

- [[algebra-category-theory/tikz-lab-pullback-pasting|Pullback pasting]]
- [[algebra-category-theory/tikz-lab-adjunction-naturality|Adjunction naturality]]
- [[algebra-category-theory/tikz-lab-whiskering-coherence|Whiskering and coherence]]
