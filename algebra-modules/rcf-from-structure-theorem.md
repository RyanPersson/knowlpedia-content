...
This is an application of the {{< knowl id="structure-theorem-pid" text="structure theorem over a PID" >}} to the {{< knowl id="polynomial-ring" section="algebra-rings" text="polynomial ring" >}} $F[x]$ (with $F$ a {{< knowl id="field" section="algebra-rings" text="field" >}}), after encoding a {{< knowl id="linear-map" section="linear-algebra" text="linear map" >}} on a {{< knowl id="vector-space" section="linear-algebra" text="vector space" >}} as a {{< knowl id="module" text="module" >}} structure; see {{< knowl id="rational-canonical-form-theorem" text="rational canonical form theorem" >}}.
