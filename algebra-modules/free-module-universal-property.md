...
This universal property characterizes {{< knowl id="free-module" text="free modules" >}} as the “linearizations” of {{< knowl id="set" section="analysis" text="sets" >}}, turning {{< knowl id="function" section="shared-foundations" text="functions" >}} into {{< knowl id="module-homomorphism" text="module homomorphisms" >}} by unique extension.
