...
A **ring homomorphism** is a {{< knowl id="function" section="shared-foundations" text="function" >}} $\varphi:R\to S$ between {{< knowl id="ring" text="rings" >}} such that for all $a,b\in R$,
\[
...
Homomorphisms organize rings into a category; they compose via {{< knowl id="composition" section="shared-foundations" text="composition" >}}. Two fundamental invariants are the {{< knowl id="kernel-ring" text="kernel" >}} and image, which control quotients and embeddings.
