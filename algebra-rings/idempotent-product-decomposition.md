...
A {{< knowl id="idempotent-element" text="central idempotent" >}} in the {{< knowl id="center-of-ring" text="center" >}} splits a ring into a {{< knowl id="cartesian-product" section="shared-foundations" text="product" >}} of rings via complementary {{< knowl id="ideal" text="ideals" >}}. This mechanism is closely related to {{< knowl id="chinese-remainder-decomposition" text="Chinese remainder decompositions" >}} and is often used to build explicit splittings from orthogonal idempotents.