...
\]
with operation given by multiplication in $R$. This is a {{< knowl id="group" section="algebra-groups" text="group" >}}, and it consists exactly of the {{< knowl id="unit" text="units" >}} of $R$.
