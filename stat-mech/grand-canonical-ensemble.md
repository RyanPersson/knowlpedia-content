...
$$
which connects directly to response coefficients such as compressibility (a special case of {{< knowl id="susceptibility-stat-mech" text="susceptibility–fluctuation relations" >}}).
