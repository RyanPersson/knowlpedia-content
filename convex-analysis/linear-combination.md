...
Let $X$ be a {{< knowl id="vector-space" section="linear-algebra" text="vector space" >}} over a field $K$. Given vectors $x_1,\dots,x_m\in X$ and scalars $\alpha_1,\dots,\alpha_m\in K$, a **linear combination** of $x_1,\dots,x_m$ is any vector of the form
$$
