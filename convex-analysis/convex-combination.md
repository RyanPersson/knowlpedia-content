...
Let $X$ be a real {{< knowl id="vector-space" section="linear-algebra" text="vector space" >}}. A vector $x\in X$ is a **convex combination** of points $x_1,\dots,x_m\in X$ if there exist scalars $\lambda_1,\dots,\lambda_m\ge 0$ with
$$
