...
Linear operators are the morphisms of {{< knowl id="vector-space" section="linear-algebra" text="vector spaces" >}}. Their {{< knowl id="image-and-kernel-linear-isomorphism" text="kernels and images" >}} give canonical subspaces, and the associated quotient describes the operator up to isomorphism.
