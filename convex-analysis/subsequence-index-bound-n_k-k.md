...
This estimate is often used when transferring "eventually" statements from a sequence to a {{< knowl id="subsequence" section="real-analysis" section="analysis" text="subsequence" >}} (e.g., to compare thresholds $N$ and $K$).
