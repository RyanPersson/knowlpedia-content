...
Let $X$ be a real {{< knowl id="vector-space" section="linear-algebra" text="vector space" >}}, let $Y\subset X$ be a {{< knowl id="linear-subspace" text="subspace" >}}, and let $p:X\to\mathbb{R}$ be a {{< knowl id="seminorm" text="seminorm" >}}.
