...
**Supremum of Convex Functions**: Let $X$ be a {{< knowl id="vector-space" section="linear-algebra" section="linear-algebra" text="vector space" >}} and let $\{f_i:X\to\overline{\mathbb{R}}\}_{i\in I}$ be a family of {{< knowl id="convex-function-via-epigraph" text="convex functions" >}} indexed by a nonempty set $I$. Define
$$
