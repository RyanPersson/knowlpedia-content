...
Let $X$ be a {{< knowl id="vector-space" section="linear-algebra" section="linear-algebra" text="vector space" >}}. An {{< knowl id="affine-set" text="affine set" >}} $\Omega\subset X$ is called a **hyperplane** if it has {{< knowl id="codimension" text="codimension" >}} one.
