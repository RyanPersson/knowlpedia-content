...
Let $X$ be a {{< knowl id="vector-space" section="linear-algebra" section="linear-algebra" text="vector space" >}}. A subset $\Omega\subset X$ is **affine** if for all $a,b\in\Omega$ we have
$$
L[a,b]\subset \Omega,
$$
