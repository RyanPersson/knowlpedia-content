...
With the inherited operations, $Y$ is itself a {{< knowl id="vector-space" section="linear-algebra" section="linear-algebra" text="vector space" >}}, and many constructions in analysis arise as subspaces (kernels, images, function spaces, etc.). Subspaces are also the building blocks for {{< knowl id="quotient-vector-space-codimension" text="quotient spaces" >}} and {{< knowl id="direct-sum-of-subspaces" text="direct sums" >}}.
