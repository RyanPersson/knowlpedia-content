+++
id = "algebra-category-theory/left-exact-functor"
...
prerequisites = ["algebra-category-theory/abelian-category", "algebra-category-theory/additive-category", "algebra-category-theory/functor", "algebra-category-theory/limit", "algebra-category-theory/kernel-categorical"]
...
The functor \(F\) is **left exact** if it preserves finite [[algebra-category-theory/limit|limits]]; equivalently (in abelian categories), if it preserves [[algebra-category-theory/kernel-categorical|kernels]].
...
- If \(F\) is both left exact and [[algebra-category-theory/right-exact-functor|right exact]], then \(F\) is [[algebra-category-theory/exact-functor|exact]].
