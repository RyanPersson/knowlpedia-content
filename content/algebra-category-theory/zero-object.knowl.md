+++
id = "algebra-category-theory/zero-object"
title = "Zero object"
kind = "knowl"
...
Any two zero objects are uniquely isomorphic. In a [[algebra-category-theory/preadditive-category|preadditive category]], the composite \(X\to0\to Y\) is the zero morphism from \(X\) to \(Y\). A category equipped with a zero object is often called pointed.
