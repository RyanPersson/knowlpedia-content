+++
id = "algebra-category-theory/additive-category"
...
2. [[algebra-category-theory/composition-category|Composition]] is bilinear: for morphisms \(f,f':A\to B\) and \(g,g':B\to C\),
   \[
...
4. \(\mathcal A\) has **binary biproducts**: for all objects \(A,B\) there exists an object \(A\oplus B\) with morphisms
   ...
   \]
   such that \((A\oplus B, p_A,p_B)\) is a [[algebra-category-theory/categorical-product|product]] of \(A,B\), and \((A\oplus B, i_A,i_B)\) is a [[algebra-category-theory/coproduct|coproduct]] of \(A,B\), and the following identities hold:
   \[
