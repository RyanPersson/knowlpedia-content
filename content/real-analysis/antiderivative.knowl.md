+++
id = "real-analysis/antiderivative"
...
The [[real-analysis/fundamental-theorem-of-calculus-i|Fundamental Theorem of Calculus]] states that if \(f\) is continuous, then
$$
F(x) = \int_a^x f(t)\, dt
$$
