...
Equivalently, near a regular point, the [[real-analysis/constraint-set|constraint set]] \(F^{-1}(0)\) is locally a graph, as guaranteed by the [[real-analysis/implicit-function-theorem|implicit function theorem]].
