+++
id = "real-analysis/regular-point-critical-point-multivariable"
...
A point $a\in U$ is a **regular point** of $f$ if the derivative ([[real-analysis/jacobian-matrix|Jacobian]]) $Df(a):\mathbb{R}^n\to\mathbb{R}^m$ has rank $m$ (equivalently, $Df(a)$ is surjective).
