...
kind = "knowl"
summary = "Nonempty subsets of R that are bounded below have an infimum in R"
...
**Greatest Lower Bound Theorem**: If $E\subseteq \mathbb{R}$ is nonempty and [[real-analysis/bounded-below|bounded below]], then $\inf E$ exists in $\mathbb{R}$.
