...
**Mean value theorem:** Let $f:[a,b]\to\mathbb{R}$ be continuous on $[a,b]$ and [[real-analysis/differentiability-1d|differentiable]] on $(a,b)$. Then there exists $c\in(a,b)$ such that
$$
