+++
id = "real-analysis/riemann-integrability-implies-boundedness"
...
prerequisites = ["real-analysis/riemann-integrable-function", "real-analysis/bounded-above", "real-analysis/bounded-below"]
...
This is a necessary condition for the [[real-analysis/riemann-integral|Riemann integral]] to be well-defined, since [[real-analysis/upper-sum|upper sums]] and [[real-analysis/lower-sum|lower sums]] take suprema and infima of \(f\) on subintervals of a [[real-analysis/partition-of-an-interval|partition]].
