+++
id = "real-analysis/differentiability-one-variable"
...
$$
exists. This limit, when it exists, is the [[real-analysis/derivative|derivative]] of \(f\) at \(x_0\).
...
## Implications
- Differentiability at \(x_0\) implies [[real-analysis/continuity-at-a-point|continuity at]] \(x_0\).
