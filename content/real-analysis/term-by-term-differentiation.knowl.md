...
**Term-by-term differentiation for [[real-analysis/power-series|power series]]:** Let \(\sum_{n=0}^\infty a_n (x-x_0)^n\) be a [[real-analysis/power-series|power series]] with radius of convergence \(R>0\), and define
\[
