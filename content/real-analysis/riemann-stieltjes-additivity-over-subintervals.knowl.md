...
For the mesh-limit definition used here, compare two fine [[real-analysis/tagged-partition|tagged partitions]] on
...
reference states the increasing-integrator case using upper and [[real-analysis/lower-sum|lower sums]];
