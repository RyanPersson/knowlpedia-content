+++
id = "real-analysis/riemann-stieltjes-integrability-theorem"
...
Since every [[real-analysis/monotone-function|monotone function]] has bounded variation, this theorem extends existence of the [[real-analysis/riemann-integral|Riemann integral]] (the case \(g(x)=x\)) to a wider class of integrators.
