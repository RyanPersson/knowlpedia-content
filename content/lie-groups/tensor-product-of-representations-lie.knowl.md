...
kind = "knowl"
summary = "The diagonal action on : for Lie algebras acts by Leibniz, for Lie groups by tensoring operators."
...
Thus the set of [[lie-groups/weight-of-a-representation|weights]] of $V\otimes W$ is contained in the Minkowski sum of the weight sets of $V$ and $W$. This is one of the basic mechanisms behind Clebsch–Gordan type decompositions and highest-weight calculations (compare [[lie-groups/highest-weight-representation|highest-weight representations]]).
