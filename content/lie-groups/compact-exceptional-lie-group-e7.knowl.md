+++
id = "lie-groups/compact-exceptional-lie-group-e7"
title = "Compact exceptional Lie group E7"
kind = "knowl"
...
The three-generation construction performs its calculations in the complex Lie algebra \(\mathfrak e_7\), but it can be translated to the compact real form and the compact [[mathematical-physics/standard-model-gauge-group|Standard Model gauge group]]
\[
S(U(2)\times U(3))\cong
(U(1)\times SU(2)\times SU(3))/\mathbb Z_6.
\]
At group level the subgroups integrating \(\mathfrak{sl}_2\oplus\mathfrak{so}_{12}\) or \(\mathfrak{sl}_3\oplus\mathfrak{sl}_6\) involve finite [[lie-groups/central-quotient-of-a-lie-group|central quotients]]; the displayed Lie-algebra direct sums alone do not determine those quotients.

## References

1. John Frank Adams, *Lectures on Exceptional Lie Groups*, University of Chicago Press, 1996, Chapters 7--9. [Publisher record](https://press.uchicago.edu/ucp/books/book/chicago/L/bo3683975.html).
2. Anthony W. Knapp, *Lie Groups Beyond an Introduction*, 2nd ed., Birkhauser, 2002, Chapter VII. [Publisher record](https://doi.org/10.1007/978-1-4757-2453-0).
