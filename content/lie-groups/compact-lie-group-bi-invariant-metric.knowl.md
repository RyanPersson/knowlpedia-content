...
**Idea of construction (averaging).** Start with any inner product \(\langle\cdot,\cdot\rangle_0\) on \(\mathfrak{g}\), and define a new inner product by averaging over \(G\) using [[harmonic-analysis/haar-measure|Haar measure]]:
\[
