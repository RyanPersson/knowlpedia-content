...
A differential \(k\)-form \(\omega\in\Omega^k(G)\) is **bi-invariant** if
\[
...
Every left-invariant \(k\)-form is determined by its value \(\omega_e\in\bigwedge^k\mathfrak g^*\) at the identity. It is bi-invariant if and only if \(\omega_e\) is invariant under the [[lie-groups/adjoint-action-of-a-lie-group|adjoint action]]:
\[
