...
**Basic properties.**
- \(Z(G)\) is a normal subgroup (indeed [[algebra-groups/characteristic-subgroup|characteristic]]), hence a [[lie-groups/normal-lie-subgroup|normal Lie subgroup]] whenever it is an embedded Lie subgroup.
