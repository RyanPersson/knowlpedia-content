...
\]
The representation is irreducible; changing \(\ell\) within its coadjoint orbit or changing the polarization does not change its unitary-equivalence class; and every irreducible unitary representation arises this way [Kirillov, Chapter 3](https://bookstore.ams.org/GSM/64). With the [[topology/quotient-topology|quotient topology]] on \(\mathfrak g^*/G\) and the [[harmonic-analysis/fell-topology|Fell topology]] on \(\widehat G\), the correspondence is a homeomorphism.
