...
\]
Thus a \((\mathfrak g,K)\)-module retains both differential operators coming from \(G\) and the discrete decomposition into irreducible compact-group types. Wallach gives this definition and its basic algebraic consequences in [§3.3](https://shop.elsevier.com/books/real-reductive-groups-i/wallach/978-0-12-732960-4).
