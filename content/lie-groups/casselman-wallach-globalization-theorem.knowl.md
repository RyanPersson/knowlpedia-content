...
\]
the span obtained by acting on \(V\) with the Harish–Chandra Schwartz algebra. Their proof also shows that minimal and maximal smooth Fréchet globalizations coincide [Bernstein–Krötz, Introduction and §8.3].
