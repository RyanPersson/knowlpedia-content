...
## Context
As the Lie algebra of a compact Lie group, \(\mathfrak u(n)\) is reductive: it splits as the direct sum of its center and the semisimple ideal \(\mathfrak{su}(n)\); see [[lie-groups/lie-algebra-compact-is-reductive|compact Lie algebras are reductive]].
