...
domains = ["lie-groups"]
prerequisites = ["fiber-bundles/lie-bracket", "lie-groups/general-linear-lie-algebra", "lie-groups/simple-lie-algebra", "lie-groups/classification-simple-lie-algebras"]
