...
If \(G\) is a [[lie-groups/compact-lie-group|compact Lie group]], then every finite-dimensional continuous real or complex representation admits a \(G\)-invariant inner product, obtained by averaging. It is therefore completely reducible.

## Equivalent characterizations

For a finite-dimensional representation, the invariant-complement property is equivalent to being a finite direct sum of [[lie-groups/irreducible-representation-lie-algebra|irreducible representations]].
