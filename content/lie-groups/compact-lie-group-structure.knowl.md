...
prerequisites = ["lie-groups/compact-lie-group", "lie-groups/connected-lie-group", "lie-groups/center-of-a-lie-algebra", "lie-groups/cartans-criterion-semisimplicity", "lie-groups/abelian-lie-group"]
...
- a torus \(T\) (a compact connected [[lie-groups/abelian-lie-group|abelian Lie group]]),
...
This decomposition is one conceptual reason compact Lie groups have especially rigid representation theory, via [[lie-groups/peter-weyl-theorem|Peter–Weyl]] and [[lie-groups/highest-weight|highest-weight]] methods (see [[lie-groups/highest-weight-theorem|the highest weight theorem]]).
