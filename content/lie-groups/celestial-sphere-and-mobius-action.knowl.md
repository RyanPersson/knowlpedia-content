...
\]
the action of the proper orthochronous Lorentz group on the [[differential-geometry/celestial-sphere|celestial sphere]] is the standard Möbius action. If
\[
...
The resulting transformations preserve the conformal structure of the round \(2\)-sphere, though not generally a chosen round metric. Orientation-reversing conformal maps require complex conjugation and lie outside \(SO^+(1,3)\).
