...
\]
is smooth. Approximate identities of such functions converge strongly to the identity, proving the density of \(\mathcal H^\infty\); this is commonly called Gårding's argument [Warner, §4.4].
