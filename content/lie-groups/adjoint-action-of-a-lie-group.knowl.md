...
The kernel of \(\operatorname{Ad}\) is the centralizer of the identity component \(G^\circ\). In particular, if \(G\) is connected, then
\[
\ker(\operatorname{Ad})=Z(G),
\]
the [[lie-groups/center-of-a-lie-group|center of \(G\)]].
