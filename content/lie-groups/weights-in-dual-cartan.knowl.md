+++
id = "lie-groups/weights-in-dual-cartan"
...
Fix a set of [[lie-groups/simple-root|simple roots]] and corresponding coroots $H_\alpha\in\mathfrak h$ (defined so that $\beta(H_\alpha)$ are the Cartan integers). The **integral weight lattice** is
$$
