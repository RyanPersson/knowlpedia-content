+++
id = "thermodynamics/thermodynamic-limit-convention"
title = "Thermodynamic limit convention"
kind = "knowl"
summary = "Standard convention for taking particle number and volume to infinity while keeping density fixed."
aliases = ["thermodynamic-limit-convention", "Thermodynamic limit convention"]
domains = ["thermodynamics"]
legacy_source_path = "thermodynamics/thermodynamic-limit-convention.md"
+++
...
$$
By convention, \(\ln\) is the natural logarithm; see [[thermodynamics/logarithm-convention-natural|natural logarithm convention]].
...
Finite-volume quantities depend on the choice of boundary condition, but for many short-range models the thermodynamic limit of bulk densities (when it exists) is independent of boundary conditions along regular sequences of regions. See [[thermodynamics/boundary-condition-convention-lattice|boundary condition convention for lattice systems]].
