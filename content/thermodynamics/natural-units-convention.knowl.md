+++
id = "thermodynamics/natural-units-convention"
title = "Natural units convention"
kind = "knowl"
summary = "Convention (often ) that measures temperature in energy units and treats entropy as dimensionless, simplifying statistical-mechanical formulas."
aliases = ["natural-units-convention", "Natural units convention"]
domains = ["thermodynamics"]
legacy_source_path = "thermodynamics/natural-units-convention.md"
+++

## Definition (and physical meaning)

The **natural units convention** in thermodynamics/statistical mechanics is the choice of units in which the [[thermodynamics/boltzmann-constant|Boltzmann constant]] is set to unity:
$$
k_B = 1.
$$

With this convention, [[thermodynamics/temperature-thermo|temperature]] has the same units as energy, and the thermodynamic [[thermodynamics/thermodynamic-entropy|entropy]] is naturally treated as a **dimensionless** quantity (because it is really $S/k_B$ that appears as a logarithm).
...
- **Inverse temperature simplifies.** The [[thermodynamics/inverse-temperature-beta|inverse temperature]] becomes
  $$
  \beta=\frac{1}{T}.
  $$
