+++
id = "thermodynamics/chemical-equilibrium"
title = "Chemical equilibrium"
kind = "knowl"
summary = "Equilibrium with respect to matter exchange and reactions: no net particle flow and chemical potentials satisfy the appropriate equalities."
aliases = ["chemical-equilibrium", "Chemical equilibrium"]
domains = ["thermodynamics"]
legacy_source_path = "thermodynamics/chemical-equilibrium.md"
+++
...
this yields $\mu_1/T_1 = \mu_2/T_2$. When the subsystems are also in [[thermodynamics/thermal-equilibrium|thermal equilibrium]] so that $T_1=T_2$, it reduces to $\mu_1=\mu_2$.
...
linking $\mu$ to derivatives of [[thermodynamics/internal-energy-thermo|internal energy]] $U$, [[thermodynamics/helmholtz-free-energy|Helmholtz free energy]] $F$, and [[thermodynamics/gibbs-free-energy|Gibbs free energy]] $G$ in the natural variables of each potential.

**Open systems and reservoirs.** A system that can exchange particles with a reservoir is an [[thermodynamics/open-system|open system]]; at fixed $(T,V,\mu)$ the equilibrium state minimizes the [[thermodynamics/grand-potential|grand potential]].
