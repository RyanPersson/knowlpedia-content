+++
id = "thermodynamics/boundary-condition-convention-lattice"
title = "Boundary condition convention for lattice systems"
kind = "knowl"
summary = "Common boundary condition choices for finite lattice models and how they affect finite-volume definitions."
aliases = ["boundary-condition-convention-lattice", "Boundary condition convention for lattice systems"]
domains = ["thermodynamics"]
legacy_source_path = "thermodynamics/boundary-condition-convention-lattice.md"
+++
...
For many short-range, translation-invariant models, the **free energy per site** (and other bulk thermodynamic quantities) converge to a limit that does not depend on the boundary condition, provided the boundary-to-volume ratio vanishes along the chosen sequence of regions. See [[thermodynamics/thermodynamic-limit-convention|thermodynamic limit convention]] for the standard scaling limit in which boundary effects become negligible.
