+++
id = "thermodynamics/zeroth-law-equivalence"
title = "Zeroth-law equivalence"
kind = "knowl"
summary = "The equivalence relation on equilibrium states induced by mutual thermal equilibrium, enabling a consistent definition of temperature."
aliases = ["zeroth-law-equivalence", "Zeroth-law equivalence"]
domains = ["thermodynamics"]
legacy_source_path = "thermodynamics/zeroth-law-equivalence.md"
+++

Define a relation $\sim$ on equilibrium states as follows: for two systems (or two equilibrium states) $A$ and $B$, write $A \sim B$ if placing them in contact through a [[thermodynamics/diathermal-wall|diathermal contact]] produces no net heat flow and no macroscopic change—i.e., they are in [[thermodynamics/thermal-equilibrium|thermal equilibrium]].
...
- **Transitive:** if $A \sim B$ and $B \sim C$ then $A \sim C$ (the substantive content of the [[thermodynamics/zeroth-law-thermodynamics|zeroth law]]).
