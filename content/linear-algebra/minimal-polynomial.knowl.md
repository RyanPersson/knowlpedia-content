...
prerequisites = ["linear-algebra/linear-operator", "algebra-rings/polynomial-ring", "convex-analysis/basis-hamel-basis-and-dimension"]
...
On the zero vector space, the minimal polynomial is \(1\): the identity endomorphism is also the zero endomorphism.
...
- For the identity operator \(I\) on a nonzero space, the minimal polynomial is \(m_I(t)=t-1\).
