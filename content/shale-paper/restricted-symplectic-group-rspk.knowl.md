+++
id = "shale-paper/restricted-symplectic-group-rspk"
...
In Shale's Theorem 4.1 ([[shale-paper/fock-cook-quantization|Fock–Cook quantization]]), \(T\) is unitarily implementable iff \(T\in rSp(K)\),
