...
prerequisites = ["lie-groups/symplectic-group-spk", "mathematical-physics/weyl-ccr-quantization", "shale-paper/cstar-algebra-observables", "operator-algebras/star-automorphism"]
dependency_heuristic = "component-dependency-review-v1"
dependency_review_count = 2
+++

For [[lie-groups/symplectic-group-spk|\(T\in Sp(K)\)]], \(\theta(T)\) is the unique [[operator-algebras/star-automorphism|*-automorphism]] of the CCR [[shale-paper/cstar-algebra-observables|\(C^*\)-algebra of observables]] \(\mathfrak A\) such that
\[
