+++
id = "algebraic-geometry-foundations/root-vs-weight-lattice-isogeny"
...
prerequisites = ["algebraic-geometry-foundations/split-reductive-group", "algebraic-geometry-foundations/maximal-torus-weight-lattice", "lie-groups/root-lattice", "lie-groups/weight-lattice", "algebraic-geometry-foundations/simply-connected-semisimple-group", "lie-groups/root-system"]
dependency_heuristic = "semantic-full-review-v1"
dependency_review_count = 1
+++

Let \(G\) be a
[[algebraic-geometry-foundations/split-reductive-group|split semisimple group]]
with [[algebraic-geometry-foundations/maximal-torus-weight-lattice|maximal torus]]
...
[[algebraic-geometry-foundations/simply-connected-semisimple-group|central isogeny
forms]] with the given [[lie-groups/root-system|root system]]. The
[[algebraic-geometry-foundations/simply-connected-semisimple-group|simply connected
...
[[lie-groups/coroots-and-pairing|coroot lattice]] and
\(P^\vee\) the
...
[[algebra-modules/dual-lattice|dual lattice]] fixes the dual group's
