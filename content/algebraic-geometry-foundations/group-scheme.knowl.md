...
Equivalently, for every \(S\)-scheme \(T\), the set of \(T\)-valued points \(G(T)=\operatorname{Hom}_S(T,G)\) is a group, functorially in \(T\). A right [[algebra-groups/group-action|action]] of \(G\) on an \(S\)-scheme \(P\) is a morphism
