+++
id = "algebraic-geometry-foundations/chevalley-lattice-integral-model"
...
prerequisites = ["lie-groups/chevalley-basis", "lie-groups/semisimple-lie-algebra", "lie-groups/universal-enveloping-algebra", "algebraic-geometry-foundations/group-scheme", "lie-groups/roots-weights-weyl"]
dependency_heuristic = "semantic-full-review-v1"
dependency_review_count = 1
+++

A [[lie-groups/chevalley-basis|Chevalley basis]] of a split
...
[[lie-groups/roots-weights-weyl|root datum]].
...
is [[harmonic-analysis/maximal-compact-hyperspecial|hyperspecial]]. For
