...
prerequisites = ["algebraic-geometry-foundations/reductive-algebraic-group", "algebraic-geometry-foundations/borel-subgroup"]
...
Every [[algebraic-geometry-foundations/split-reductive-group|split reductive group]]
is quasi-split, but the converse can fail: a quasi-split group need not have
a split
[[algebraic-geometry-foundations/maximal-torus-weight-lattice|maximal torus]]. After
...
An [[algebraic-geometry-foundations/galois-descent-forms|inner class]] over a
[[algebra-fields-galois/local-field|local]] or [[algebra-fields-galois/global-local-fields-completions|global field]] has a quasi-split representative, unique up to isomorphism. The
...
resulting
[[algebra-fields-galois/galois-extension-and-group|Galois action]] on the
[[lie-groups/roots-weights-weyl|based root datum]] defines the
[[algebraic-geometry-foundations/pinned-automorphisms|pinned action]] used
