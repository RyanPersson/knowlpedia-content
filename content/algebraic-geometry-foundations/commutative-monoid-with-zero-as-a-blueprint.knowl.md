...
The [[algebraic-geometry-foundations/semiring-completion-of-a-blueprint|semiring completion]] of \(A^{\mathrm{blpr}}\) is the free commutative semiring generated by the monoid \(A\), with the monoid zero identified with the additive zero. It is not an addition law on \(A\).
