...
**Warning.** Connected does not mean [[topology/irreducible-space|irreducible]], path connected, or connected in a Euclidean topology. Schemes are being tested in their Zariski topology, whose open sets are usually much larger than familiar analytic open sets.
