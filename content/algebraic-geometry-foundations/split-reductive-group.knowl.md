+++
id = "algebraic-geometry-foundations/split-reductive-group"
...
prerequisites = ["algebraic-geometry-foundations/unipotent-radical", "algebraic-geometry-foundations/maximal-torus-weight-lattice"]
...
For split \(G\), the
[[algebraic-geometry-foundations/maximal-torus-weight-lattice|character and
cocharacter lattices]] of \(T\),
[[lie-groups/roots-weights-weyl|roots]],
[[lie-groups/coroots-and-pairing|coroots]], and a choice of
...
[[langlands/langlands-dual-group|\(\widehat G\)]]. For a
...
[[algebraic-geometry-foundations/galois-descent-forms|Galois descent and inner
