+++
id = "algebraic-geometry-foundations/maximal-torus-weight-lattice"
...
prerequisites = ["algebraic-geometry-foundations/algebraic-group", "algebra-fields-galois/algebraic-closure", "algebra-groups/abelian-group", "algebra-fields-galois/galois-extension-and-group"]
...
the
[[algebraic-geometry-foundations/root-vs-weight-lattice-isogeny|isogeny form]] of a
semisimple group.
...
The full [[lie-groups/roots-weights-weyl|based root datum]] uses
both \(X^*(T)\) and \(X_*(T)\). Exchanging them, and
[[lie-groups/coroots-and-pairing|roots with coroots]], defines
the
