+++
id = "algebraic-geometry-foundations/borel-mostow-semisimple-normalizer"
...
prerequisites = ["algebraic-geometry-foundations/algebraic-group", "algebraic-geometry-foundations/semisimple-element-and-class", "algebraic-geometry-foundations/maximal-torus-weight-lattice", "algebra-groups/normalizer"]
...
[[algebraic-geometry-foundations/semisimple-element-and-class|semisimple element]]
\(s\in H\) normalizes some
[[algebraic-geometry-foundations/maximal-torus-weight-lattice|maximal torus]] of
...
[[langlands/langlands-dual-group|\(\widehat G\)]]
\(\rtimes\Gamma\).
In an [[langlands/l-group|\(L\)-group]], an
[[langlands/satake-parameter|unramified parameter]] lies in a
[[algebra-fields-galois/frobenius-unramified|Frobenius]] coset
