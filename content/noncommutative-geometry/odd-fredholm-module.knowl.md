...
P=\frac{I+F}{2}
\]
is an [[linear-algebra/orthogonal-projection|orthogonal projection]]. Compactness of \([F,\pi(a)]\) is equivalent to compactness of \([P,\pi(a)]\). Consequently \(P\pi(a)P\) is multiplicative modulo compact operators, which is the Toeplitz-type mechanism behind the [[noncommutative-geometry/odd-index-pairing|odd index pairing]]. [Connes, Chapter IV, Section 1, Proposition 2(b)](https://alainconnes.org/wp-content/uploads/book94bigpdf.pdf).
