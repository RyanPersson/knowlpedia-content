...
\sum_j a_j[D,b_j]
\]
are compatible with the right \(\mathcal A\)-module structure. This is the reason the condition is separated from the bimodule-producing order-zero axiom [Connes and Marcolli, equation (1.473)].
