...
\end{pmatrix}.
\]
For a normalized module, \(F^-=(F^+)^*\) and the two off-diagonal operators are mutual inverses. Before normalization they are inverses modulo the locally compact defects specified in the Fredholm-module axioms. This is the form used to construct the [[noncommutative-geometry/even-index-pairing|even index pairing]]. [Connes, Chapter IV, Section 1, Definition 1 and Proposition 2(a)].
