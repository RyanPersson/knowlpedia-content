...
\]
Weak tau-\(p\)-summability replaces \(L^p\) by the corresponding weak ideal and permits the borderline decay \(O(t^{-1/p})\). The strong and weak conditions are not interchangeable; the latter is the natural endpoint in many dimension-\(p\) examples [Carey, Phillips, Rennie, and Sukochev, §2](https://doi.org/10.1016/j.jfa.2003.11.016).
