...
The antiunitary \(J\) abstracts charge conjugation on spinors. The formula for \(b^\circ\) turns the Hilbert space into a candidate \(\mathcal A\)-bimodule: the represented algebra acts from the left and its opposite algebra acts from the right. The KO-sign relations record the real Clifford-module behavior of \(J\), \(D\), and the grading [Connes and Marcolli, Definition 1.124](https://doi.org/10.1090/coll/055).
