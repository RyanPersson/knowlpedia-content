...
Part I derives the odd formula through spectral flow [Carey–Phillips–Rennie–Sukochev, Theorem 4.1 and §8](https://arxiv.org/abs/math/0411019). Part II proves the even formula and a generalized McKean–Singer identity [Carey–Phillips–Rennie–Sukochev, §§4–6](https://doi.org/10.1016/j.aim.2005.03.010).
