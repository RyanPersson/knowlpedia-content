...
In a [[operator-algebras/semifinite-von-neumann-algebra|semifinite von Neumann algebra]], self-adjoint Breuer-Fredholm paths have a trace-valued analogue. In type \(\mathrm{II}_\infty\), it can be real-valued rather than integer-valued and is expressed using the trace dimension of spectral projections. [Carey and Phillips] develop this version and relate it to odd unbounded [[noncommutative-geometry/fredholm-module|Fredholm modules]] and the K-theory/K-homology pairing.
