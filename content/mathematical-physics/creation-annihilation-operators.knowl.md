+++
id = "mathematical-physics/creation-annihilation-operators"
...
For \(z\in H\), the **creation operator** on the algebraic finite-particle subspace of [[mathematical-physics/symmetric-fock-space|symmetric Fock space]] \(S(H)\) is defined by
\[
