+++
id = "mathematical-physics/weyl-ccr-quantization"
...
Let \((K,B)\) be a real [[functional-analysis/symplectic-hilbert-space|symplectic
...
For the [[mathematical-physics/schrodinger-representation|Schrödinger representation]] on \(L^2(\mathbb R)\), let \(Q\) be
