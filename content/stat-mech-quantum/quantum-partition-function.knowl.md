...
Let \(H\) be a [[stat-mech-quantum/quantum-hamiltonian|Hamiltonian]] on a finite-dimensional [[linear-algebra/hilbert-space|Hilbert space]] and let \(\beta>0\). The **quantum partition function** is
\[
