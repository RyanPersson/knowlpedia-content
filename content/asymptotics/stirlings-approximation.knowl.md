+++
id = "asymptotics/stirlings-approximation"
...
$$
This form is often numerically stable and is the starting point for entropy-based approximations (see [[asymptotics/entropy-multinomial-coefficients|entropy-multinomial-coefficients]]).
...
- Converting counts into entropy-like expressions in information theory and large deviations (see [[asymptotics/method-of-types|method-of-types]]).
- Approximating integrals via local quadratic expansions (conceptually similar to [[asymptotics/laplaces-method|laplaces-method]]).
