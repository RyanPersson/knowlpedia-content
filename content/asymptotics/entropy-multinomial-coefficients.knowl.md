+++
id = "asymptotics/entropy-multinomial-coefficients"
...
Using [[asymptotics/stirlings-approximation|stirlings-approximation]], one obtains
$$
...
## Why this matters
- The exponential size of a “type class” (all sequences with the same empirical proportions) is controlled by $e^{nH(p)}$, up to polynomial factors; this is the core counting step in the [[asymptotics/method-of-types|method-of-types]].
