...
for large $n$, when the main contribution comes from a neighborhood of the point where $f$ is maximal. It is the real-variable analogue of the complex [[asymptotics/saddle-point-method|saddle-point-method]].
