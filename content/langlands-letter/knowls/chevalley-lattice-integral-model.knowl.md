...
Chevalley–Demazure [[algebraic-geometry-foundations/group-scheme|group scheme]] attached to the full root datum.
...
integral group-scheme action when that action has been constructed.
...
is hyperspecial. For a reductive group originally defined over a number
field, such a reductive integral model exists outside a finite set of bad
places rather than canonically at every place.

## Relation to the letter

The letter uses lattices to define integral points and hence the unramified
[[harmonic-analysis/hecke-algebra-locally-compact-group-pair|spherical Hecke algebra]] at almost all primes. Modern language separates the
