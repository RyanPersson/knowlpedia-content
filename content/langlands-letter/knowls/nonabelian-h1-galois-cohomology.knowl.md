...
Two cocycles are cohomologous when
...
using continuous cocycles. It classifies \(G\)-torsors over \(k\) up to
...
\(G_\gamma\), rational [[algebra-groups/conjugacy-class|conjugacy classes]] inside its stable class are
parametrized by
...
endoscopy and \(\kappa\)-orbital integrals.
