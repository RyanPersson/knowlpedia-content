...
A **Lebesgue measure** on $\mathbb{R}^n$ is the [[measure-theory/measure|measure]] $\lambda^n$ obtained by applying the [[measure-theory/caratheodory-construction|Carathéodory construction]] to the [[measure-theory/outer-measure|outer measure]] $\lambda^{n,*}$ defined by
$$
\lambda^{n,*}(E)
...
where a [[measure-theory/measurable-rectangle|measurable rectangle]] is typically a half-open box $R=\prod_{i=1}^n (a_i,b_i]$ and
$$
\operatorname{vol}(R)=\prod_{i=1}^n (b_i-a_i).
$$

A set $E\subseteq \mathbb{R}^n$ is **Lebesgue measurable** if it is a [[measure-theory/caratheodory-measurable-set|Carathéodory measurable set]] for $\lambda^{n,*}$, and then $\lambda^n(E):=\lambda^{n,*}(E)$.
