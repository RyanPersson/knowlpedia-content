+++
id = "fiber-bundles/pullback-of-covectors"
...
\]
between [[fiber-bundles/tangent-space-at-a-point|tangent spaces]].
...
\]
If $F$ is a [[fiber-bundles/diffeomorphism|diffeomorphism]], then $dF_p$ is an isomorphism and $F_p^*$ is an isomorphism with inverse given by the corresponding pullback along $F^{-1}$.
