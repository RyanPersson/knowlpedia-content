...
prerequisites = ["topology/topological-group", "fiber-bundles/universal-principal-bundle-egbg", "fiber-bundles/topological-principal-bundle", "topology/continuous-map"]
dependency_heuristic = "semantic-full-review-v1"
dependency_review_count = 1
+++

Fix a [[topology/topological-group|topological group]] \(G\) and a chosen [[fiber-bundles/universal-principal-bundle-egbg|universal principal bundle]] \(EG\to BG\). For a [[fiber-bundles/topological-principal-bundle|topological principal \(G\)-bundle]] \(P\to M\), a **classifying map** is a continuous map
\[
...
2. **Hopf fibration.** The principal \(U(1)\)-bundle \(S^3\to S^2\) is classified by a map \(S^2\to BU(1)\simeq \mathbb{C}P^\infty\) representing a generator of \(H^2(S^2;\mathbb{Z})\).
