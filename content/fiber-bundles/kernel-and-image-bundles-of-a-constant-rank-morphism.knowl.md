...
\]
The coordinate spans of the zero block and the \(I_r\) block then give smooth local frames for the kernel and image. This is the vector-bundle analogue of the constant-rank normal form; see [Lee, Chapter 10](https://doi.org/10.1007/978-1-4419-9982-5).
