+++
id = "fiber-bundles/horizontal-lift-of-a-vector-field"
...
Let $X$ be a [[fiber-bundles/vector-field|vector field]] on $M$. Since $d\pi_e:H_eE\to T_{\pi(e)}M$ is an isomorphism for each $e$, one can lift $X$ pointwise and obtain a vector field on $E$.
