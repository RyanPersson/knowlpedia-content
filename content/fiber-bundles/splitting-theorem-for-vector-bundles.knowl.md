...
\]
is a fiberwise isomorphism and hence a [[fiber-bundles/bundle-isomorphism|bundle isomorphism]]. Its inverse, followed by the inclusion into \(E\), is the required right inverse \(s\).
