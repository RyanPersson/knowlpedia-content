...
3. **Change of frame.** The general linear group \(GL(n,\mathbb{R})\) acts on the frame bundle of a manifold by \(u\cdot g=u\circ g\) for a frame \(u:\mathbb R^n\to T_xM\) (precomposition of the frame by \(g\), a right action).
