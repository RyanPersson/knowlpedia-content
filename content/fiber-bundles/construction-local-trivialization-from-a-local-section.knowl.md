+++
id = "fiber-bundles/construction-local-trivialization-from-a-local-section"
...
Let $\pi:P\to M$ be a [[fiber-bundles/principal-g-bundle|principal G-bundle]] with right action $(p,g)\mapsto p\cdot g$. Let $U\subset M$ be open and let $s:U\to P$ be a smooth local section, i.e. $\pi\circ s=\mathrm{id}_U$.
...
3. **Local connection 1-form.** Given a principal connection $\omega$ on $P$, the local connection form is $A=s^*\omega\in\Omega^1(U;\mathfrak g)$; the curvature pulls back to $F=s^*\Omega$ satisfying the identity in [[fiber-bundles/convention-local-curvature-convention-f-da-aa|the local curvature convention]].
