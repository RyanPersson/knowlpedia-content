+++
id = "fiber-bundles/frame-bundle-frame-bundle-of-a-rank-n-vector-bundle"
...
With its standard smooth structure (built from local trivializations of $E$), $(\mathrm{Fr}(E),p)$ is a [[fiber-bundles/principal-g-bundle|principal G-bundle]] with structure group $\mathrm{GL}(n,\mathbb F)$.
