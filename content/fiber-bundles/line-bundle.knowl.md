...
Over a paracompact space, complex line bundles are classified by their first Chern class in \(H^2(M;\mathbb Z)\). Real line bundles are classified by their first [[fiber-bundles/stiefel-whitney-class|Stiefel–Whitney class]] in \(H^1(M;\mathbb Z/2)\) [Husemoller, chapter 3].
