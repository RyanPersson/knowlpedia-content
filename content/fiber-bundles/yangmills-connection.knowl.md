...
Let $P\to M$ be a principal $G$-bundle over an oriented Riemannian manifold, and fix an $\operatorname{Ad}$-invariant inner product on the Lie algebra of $G$.
...
3. **Surfaces.** On an oriented surface, the Yang–Mills equation says that the adjoint-bundle-valued function $*F_A$ is covariantly constant.
