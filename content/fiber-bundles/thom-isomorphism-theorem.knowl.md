...
\]
where \(D(E)\) and \(S(E)\) are the disk and [[fiber-bundles/sphere-bundle|sphere bundles]]. Collapsing \(S(E)\) gives the reduced cohomology of the Thom space. These models express the same isomorphism with different support conventions [Milnor–Stasheff, chapter 10].
