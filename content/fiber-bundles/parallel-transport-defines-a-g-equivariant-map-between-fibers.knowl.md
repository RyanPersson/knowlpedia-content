+++
id = "fiber-bundles/parallel-transport-defines-a-g-equivariant-map-between-fibers"
title = "Theorem: Parallel transport defines a G-equivariant map between fibers"
kind = "knowl"
summary = "Parallel transport along a curve yields a right G-equivariant diffeomorphism between principal bundle fibers."
...
Let $\pi:P\to M$ be a [[fiber-bundles/principal-g-bundle|principal G-bundle]] with a [[fiber-bundles/principal-connection|principal connection]].
...
This map is the principal-bundle version of [[fiber-bundles/parallel-transport|parallel transport]].
