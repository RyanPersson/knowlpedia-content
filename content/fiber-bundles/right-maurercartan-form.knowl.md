+++
id = "fiber-bundles/right-maurercartan-form"
title = "Right Maurer–Cartan form"
kind = "knowl"
summary = "The canonical Lie-algebra-valued 1-form on a Lie group that identifies each tangent space with the Lie algebra by right translation."
aliases = ["right-maurercartan-form", "Right Maurer–Cartan form"]
domains = ["fiber-bundles"]
legacy_source_path = "fiber-bundles/right-maurercartan-form.md"
+++

Let $G$ be a [[fiber-bundles/lie-group|Lie group]] with Lie algebra [[lie-groups/lie-algebra|Lie algebra]] $\mathfrak{g}=T_eG$. The **right Maurer–Cartan form** is the $\mathfrak{g}$-valued 1-form $\theta^R$ on $G$ defined at each $g\in G$ by
\[
