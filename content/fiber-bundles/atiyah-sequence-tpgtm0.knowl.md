+++
id = "fiber-bundles/atiyah-sequence-tpgtm0"
...
3. **Circle bundles.** For a principal \(U(1)\)-bundle, \(\mathrm{ad}(P)\cong M\times i\mathbb{R}\) is a trivial [[fiber-bundles/line-bundle|line bundle]], and the sequence exhibits \(TP/U(1)\) as an extension of \(TM\) by this line.
