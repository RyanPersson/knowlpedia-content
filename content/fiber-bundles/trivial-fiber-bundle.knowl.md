+++
id = "fiber-bundles/trivial-fiber-bundle"
...
\]
covering \(\mathrm{id}_M\), i.e. \(\mathrm{pr}_1\circ \Psi=\pi\).
...
Equivalently, \(E\) admits a single global trivialization, so that all transition functions can be chosen to be the identity.
## Examples
