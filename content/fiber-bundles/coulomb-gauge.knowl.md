...
After suitable Sobolev completions and under standard regularity hypotheses, this complement yields a local slice modulo the stabilizer of \(A_0\) [Freed–Uhlenbeck, chapter 3]. It is therefore local analytical structure, not a canonical global section of the gauge-orbit map.
