...
prerequisites = ["topology/topological-manifold", "fiber-bundles/smooth-structure"]
dependency_heuristic = "axiomatic-dependency-review-v1"
dependency_review_count = 3
+++

An **\(n\)-dimensional smooth manifold** is an \(n\)-dimensional [[topology/topological-manifold|topological manifold]] equipped with a [[fiber-bundles/smooth-structure|smooth structure]].

## Examples
1. \(\mathbb{R}^n\) with the smooth structure generated by the single global chart \((\mathbb{R}^n,\mathrm{id})\) is a smooth manifold; its maximal atlas consists of all charts whose coordinate changes are smooth.
