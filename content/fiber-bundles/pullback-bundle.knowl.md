+++
id = "fiber-bundles/pullback-bundle"
...
There is a canonical map \(\widetilde f:f^*E\to E\), \(\widetilde f(n,e)=e\), which is a [[fiber-bundles/bundle-morphism|bundle morphism]] covering \(f\). Locally, if \(E|_U\cong U\times F\), then \((f^*E)|_{f^{-1}(U)}\cong f^{-1}(U)\times F\), so pullback respects local trivializations.
