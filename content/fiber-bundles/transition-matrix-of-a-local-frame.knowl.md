...
Let $\pi:E\to M$ be a rank $r$ smooth vector bundle, and let $(e_1,\dots,e_r)$ and $(e'_1,\dots,e'_r)$ be two [[fiber-bundles/local-frame-of-a-vector-bundle|local frames]] of $E$ defined on open sets $U$ and $V$, respectively. On the overlap $U\cap V$, there is a unique map
\[
