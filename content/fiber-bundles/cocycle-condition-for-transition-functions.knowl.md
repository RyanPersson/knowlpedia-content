+++
id = "fiber-bundles/cocycle-condition-for-transition-functions"
...
These conditions are exactly the statement that the changes of trivialization compose consistently, so that the local products \(U_i\times F\) glue to a well-defined [[fiber-bundles/smooth-fiber-bundle|smooth fiber bundle]].
