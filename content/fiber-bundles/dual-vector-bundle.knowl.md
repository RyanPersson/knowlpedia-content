...
Let $\pi:E\to M$ be a smooth vector bundle (real or complex) over a [[fiber-bundles/smooth-manifold|smooth manifold]]. The **dual vector bundle** of $E$ is the vector bundle
\[
\pi^*:E^*\to M
\]
