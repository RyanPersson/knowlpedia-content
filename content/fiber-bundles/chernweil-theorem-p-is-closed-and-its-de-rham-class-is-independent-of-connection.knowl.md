...
2. The form $P(\Omega)$ is **basic** (see [[fiber-bundles/lemma-chernweil-forms-are-basic|Chern–Weil forms are basic]]), hence by the [[fiber-bundles/basic-forms-theorem|basic forms theorem]] there is a unique closed form $\operatorname{cw}_P(\omega)\in\Omega^{2k}(M)$ with
   \[
