+++
id = "fiber-bundles/tangent-bundle"
...
\]
the disjoint union of all [[fiber-bundles/tangent-space-at-a-point|tangent spaces]] of \(M\), equipped with the projection map
\[
...
df:TM\to TN
\]
defined fiberwise by the [[fiber-bundles/differential-pushforward-of-a-smooth-map|differential (pushforward)]] \(d f_p:T_pM\to T_{f(p)}N\). This “bundle map” covers \(f\) in the sense that \(\pi_N\circ df = f\circ \pi_M\).
...
(For comparison, the dual bundle of \(TM\) is the [[fiber-bundles/cotangent-bundle|cotangent bundle]].)
