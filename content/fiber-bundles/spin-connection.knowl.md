...
\]
This compatibility is the bridge from Riemannian parallel transport to the [[noncommutative-geometry/dirac-operator|Dirac operator]]; see [Lawson–Michelsohn, Chapter II, §§4–5](https://doi.org/10.1515/9781400883912).
...
\]
The factor depends on summation conventions, but the invariant lifting equation in the core does not [Friedrich, Chapters 2–3](https://doi.org/10.1090/gsm/025).
