+++
id = "fiber-bundles/maurercartan-equation"
title = "Maurer–Cartan equation"
kind = "knowl"
summary = "A structural identity satisfied by the Maurer–Cartan form expressing flatness of the canonical trivialization on a Lie group."
aliases = ["maurercartan-equation", "Maurer–Cartan equation"]
domains = ["fiber-bundles"]
legacy_source_path = "fiber-bundles/maurercartan-equation.md"
+++

Let $G$ be a Lie group with Lie algebra $\mathfrak{g}$. Consider the [[fiber-bundles/left-maurercartan-form|left Maurer–Cartan form]] $\theta^L\in\Omega^1(G;\mathfrak{g})$.

Define the bracket of $\mathfrak{g}$-valued 1-forms by using the [[fiber-bundles/lie-bracket|Lie bracket]] on $\mathfrak{g}$: for tangent vectors $u,v\in T_gG$ set
\[
...
\]
where $\mathrm{d}$ is the [[fiber-bundles/exterior-derivative|exterior derivative]] applied componentwise.

With the same convention, the [[fiber-bundles/right-maurercartan-form|right Maurer–Cartan form]] $\theta^R$ satisfies
\[
