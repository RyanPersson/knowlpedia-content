...
Let $E\to M$ be a complex rank-$n$ vector bundle over a [[fiber-bundles/smooth-manifold|smooth manifold]] equipped with a [[fiber-bundles/hermitian-metric|Hermitian metric]]. Let $\mathrm{U}(E)$ be its unitary frame bundle. The **special unitary frame bundle** is, informally, the subbundle of $\mathrm{U}(E)$ consisting of unitary frames whose determinant is $1$.
