...
If a [[fiber-bundles/section-of-a-vector-bundle|smooth section]] \(s:B\to E\) is transverse to the zero section, its zero set is a codimension-\(r\) submanifold whose cohomological dual is \(e(E)\), with the induced orientation. This geometric interpretation follows from the Thom construction; see [Milnor and Stasheff, Chapter 9].
