...
3. **Principal $U(1)$-bundle.** Since the adjoint action of $U(1)$ on $\mathfrak u(1)$ is trivial, the adjoint bundle is $M\times\mathfrak u(1)$. Thus the Atiyah sequence is an extension of $TM$ by this trivial line bundle; after choosing a connection, its curvature appears in the resulting bracket formula.
