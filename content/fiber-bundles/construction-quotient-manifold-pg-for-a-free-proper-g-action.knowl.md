+++
id = "fiber-bundles/construction-quotient-manifold-pg-for-a-free-proper-g-action"
...
prerequisites = ["fiber-bundles/lie-group", "fiber-bundles/smooth-manifold", "fiber-bundles/smooth-action-of-a-lie-group-on-a-manifold", "fiber-bundles/principal-g-bundle", "fiber-bundles/convention-fundamental-vector-field-x-is-defined-using-the-right-action"]
dependency_heuristic = "semantic-full-review-v1"
dependency_review_count = 1
+++

Let \(G\) be a [[fiber-bundles/lie-group|Lie group]] acting smoothly on a [[fiber-bundles/smooth-manifold|smooth manifold]] \(P\). Write the action as a right action \((p,g)\mapsto p\cdot g\).

**Quotient manifold and principal bundle projection.**
...
2. With this smooth structure, \(\pi:P\to P/G\) is a [[fiber-bundles/principal-g-bundle|principal G-bundle]] with the given right action.
...
3. **Non-example (failure of properness).** If a noncompact group acts freely but not properly, the orbit space may fail to be Hausdorff, violating the manifold convention in [[fiber-bundles/convention-manifolds-are-smooth-hausdorff-and-second-countable|the manifold hypotheses]].
