...
2. **Invariant fields on \(G\).** On \(P=G\), viewed as a principal \(G\)-bundle over a point with right action by right multiplication, \(X^\#_h=(L_h)_*X\). Thus \(X^\#\) is the left-invariant vector field generated by \(X\).
