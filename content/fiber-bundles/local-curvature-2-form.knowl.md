+++
id = "fiber-bundles/local-curvature-2-form"
...
\]
where \(d\) is the [[fiber-bundles/exterior-derivative|exterior derivative]] and the bracket uses the [[fiber-bundles/lie-bracket|Lie bracket]] on \(\mathfrak{g}\).
...
F' = \mathrm{Ad}(g^{-1})F,
\]
compatible with the [[fiber-bundles/gauge-transform-of-a-local-connection-form|gauge transformation of the local connection form]].
