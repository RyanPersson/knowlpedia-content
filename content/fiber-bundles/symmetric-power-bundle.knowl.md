...
Let $\pi:E\to M$ be a smooth vector bundle of rank $r$ over a [[fiber-bundles/smooth-manifold|smooth manifold]]. For an integer $k\ge 0$, the **k-th symmetric power bundle** of $E$ is the vector bundle
\[
S^k E \to M
\]
