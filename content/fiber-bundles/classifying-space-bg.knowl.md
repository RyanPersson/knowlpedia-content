...
Let \(G\) be a [[fiber-bundles/lie-group|Lie group]] (more generally, a suitable topological group).
...
The bundle \(EG\to BG\) is the **universal principal \(G\)-bundle**.

## Classification theorem

If \(B\) is a [[fiber-bundles/paracompact-topological-space|paracompact topological space]], then isomorphism classes of [[fiber-bundles/principal-g-bundle|principal \(G\)-bundles]] over \(B\) are naturally identified with homotopy classes \([B,BG]\).

Concretely:

- a map \(f:B\to BG\) determines the pullback bundle \(f^*(EG)\to B\);
- every principal \(G\)-bundle over \(B\) is such a pullback up to isomorphism;
...
3. **Bundles over the circle.**
   Specializing to \(B=S^1\), principal \(G\)-bundles are classified by conjugacy classes in the component group \(\pi_0(G)\). This agrees with the explicit [[fiber-bundles/principal-bundle-over-s1-defined-by-a-clutching-function|clutching description]].
