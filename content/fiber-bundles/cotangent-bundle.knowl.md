...
prerequisites = ["fiber-bundles/smooth-manifold", "fiber-bundles/tangent-space-at-a-point", "fiber-bundles/smooth-chart-coordinate-chart", "fiber-bundles/tangent-bundle"]
...
3. **Lie groups.** If \(G\) is a [[fiber-bundles/lie-group|Lie group]], then
   ...
   Dualizing gives the left trivialization
   \[
   T^*G\cong G\times\mathfrak g^*,
   \]
   where \(\mathfrak g=T_eG\) is the
   [[lie-groups/lie-algebra-of-a-lie-group|Lie algebra of \(G\)]].
