+++
id = "fiber-bundles/local-curvature-formula-f-da-aa"
...
2. **Pure gauge has zero curvature.** On a trivial bundle over $U$, take $A=g^{-1}dg$ for a smooth map $g:U\to G$. Then $F=dA+\tfrac12[A\wedge A]=0$ by the [[fiber-bundles/lemma-maurercartan-equation-for-the-left-maurercartan-form|Maurer–Cartan equation]].
