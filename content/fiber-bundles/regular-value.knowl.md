+++
id = "fiber-bundles/regular-value"
title = "Regular value"
kind = "knowl"
summary = "A point in the target such that the differential is surjective along its fiber."
aliases = ["regular-value", "Regular value"]
domains = ["fiber-bundles"]
legacy_source_path = "fiber-bundles/regular-value.md"
+++

Let \(M\) and \(N\) be [[fiber-bundles/smooth-manifold|smooth manifolds]], and let \(f:M\to N\) be a [[fiber-bundles/smooth-map|smooth map]].

A point \(y\in N\) is called a **regular value** of \(f\) if for every \(x\in f^{-1}(y)\), the [[fiber-bundles/differential-pushforward-of-a-smooth-map|differential]]
\[
...
3. **A map that is everywhere regular.** If \(f:M\to N\) is a [[fiber-bundles/smooth-submersion|smooth submersion]], then every \(y\in N\) is a regular value. For instance, for the projection \(\pi_M:M\times F\to M\), all fibers \(\pi_M^{-1}(m)=\{m\}\times F\) are smooth submanifolds.
