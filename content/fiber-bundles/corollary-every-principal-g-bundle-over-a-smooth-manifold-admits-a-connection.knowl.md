+++
id = "fiber-bundles/corollary-every-principal-g-bundle-over-a-smooth-manifold-admits-a-connection"
title = "Every principal bundle admits a connection"
kind = "knowl"
summary = "Any principal bundle over a smooth manifold admits at least one principal connection."
...
- On $P=M\times G$, the product horizontal distribution defines a principal connection.
- The principal $U(1)$-bundle $S^3\to S^2$ admits a connection whose horizontal distribution is the standard contact distribution.
