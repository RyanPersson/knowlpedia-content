+++
id = "fiber-bundles/principal-bundle-morphism"
...
A **principal bundle morphism** from $P$ to $P'$ is a [[fiber-bundles/smooth-map|smooth map]] $\Phi:P\to P'$ for which there exists a smooth map $f:M\to M'$ such that:
...
2. **Induced map on frame bundles.** If $f:M\to M'$ is a [[fiber-bundles/diffeomorphism|diffeomorphism]], then its derivative gives a morphism between the frame bundles, covering $f$, and compatible with the induced map on the [[fiber-bundles/tangent-bundle|tangent bundle]].
