+++
id = "fiber-bundles/smooth-submersion"
...
The map \(f\) is a **smooth submersion** if for every \(p\in M\), the [[fiber-bundles/differential-pushforward-of-a-smooth-map|differential (pushforward)]]
\[
