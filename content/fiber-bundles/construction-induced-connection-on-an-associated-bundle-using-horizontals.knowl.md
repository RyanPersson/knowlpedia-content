...
**Construction ([[fiber-bundles/horizontal-distribution|horizontal distribution]] on E).** For $[p,u]\in E$, define the horizontal subspace
\[
...
\]
giving an [[fiber-bundles/ehresmann-connection|Ehresmann connection]] on $E$.
...
2. For $E=\mathrm{Ad}(P)$, the construction produces a natural connection on the adjoint bundle used in [[fiber-bundles/gauge-theory|gauge theory]] to differentiate gauge parameters.
