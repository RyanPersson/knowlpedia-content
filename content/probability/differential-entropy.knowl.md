...
prerequisites = ["probability/random-vector", "measure-theory/lebesgue-measure", "measure-theory/lebesgue-integral", "probability/probability-density-function"]
dependency_heuristic = "semantic-full-review-v1"
dependency_review_count = 2
+++

Let \(X\) be an \(\mathbb R^d\)-valued [[probability/random-variable|random variable]] whose law has [[probability/probability-density-function|density]] \(f\) with respect to [[measure-theory/lebesgue-measure|Lebesgue measure]]. If the integral below is well-defined as an extended integral, the **differential entropy** of \(X\) is
\[
