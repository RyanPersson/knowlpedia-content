...
Equivalently, the [[measure-theory/sigma-algebra|sigma-algebras]] \(\sigma(X_i)\) generated by the variables are [[probability/independence-sigma-algebras|independent]].

## Remarks

This says that all events of the form \(\{X_i\in A\}\) behave like [[probability/independence-events|independent events]] under [[probability/event-probability|probability]].
