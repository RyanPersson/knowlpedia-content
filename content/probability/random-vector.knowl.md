...
- Let \(\Omega=[0,1]\) with \(\mathbb P\) the [[probability/uniform-distribution|uniform distribution]], and define \(X(\omega)=(\omega,\omega^2)\in\mathbb R^2\). Then \(X\) is a random vector in \(\mathbb R^2\).
