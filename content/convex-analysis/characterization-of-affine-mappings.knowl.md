+++
id = "convex-analysis/characterization-of-affine-mappings"
title = "Characterization of affine mappings"
kind = "knowl"
summary = "Affine maps are exactly those that preserve two-point convex combinations"
...
**Proposition.**
A map $B:X\to Y$ between real vector spaces is [[convex-analysis/affine-mapping|affine]] if and only if for all $x_1,x_2\in X$ and all $\lambda\in\mathbb{R}$,
$$
