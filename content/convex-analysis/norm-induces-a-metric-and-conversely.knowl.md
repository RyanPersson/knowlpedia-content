+++
id = "convex-analysis/norm-induces-a-metric-and-conversely"
...
**Proposition.**
Let $(X,\|\cdot\|)$ be a [[convex-analysis/norm-normed-vector-space|normed vector space]]. Define
$$
d(x,y):=\|x-y\| \quad \text{for } x,y\in X.
$$

Then $d$ is a [[convex-analysis/metric-metric-space|metric]] on $X$ (hence $(X,d)$ is a metric space).
