...
prerequisites = ["linear-algebra/vector-space", "convex-analysis/affine-set", "convex-analysis/linear-subspace", "convex-analysis/set-operations-sum-scalar-multiple-difference"]
