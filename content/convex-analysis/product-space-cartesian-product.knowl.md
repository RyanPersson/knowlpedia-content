+++
id = "convex-analysis/product-space-cartesian-product"
title = "Product space"
kind = "knowl"
summary = "A Cartesian product of vector spaces with componentwise operations"
...
becomes a [[linear-algebra/vector-space|vector space]] over $K$ by defining, for $x=(x_1,\dots,x_m)$ and $y=(y_1,\dots,y_m)$ in $X$ and $\alpha\in K$,
$$
