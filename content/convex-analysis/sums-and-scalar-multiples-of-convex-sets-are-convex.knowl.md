+++
id = "convex-analysis/sums-and-scalar-multiples-of-convex-sets-are-convex"
title = "Sums and scalar multiples of convex sets are convex"
kind = "knowl"
summary = "Minkowski sums and dilations preserve convexity"
...
**Proposition.**
Let $\Omega_1,\Omega_2$ be [[convex-analysis/convex-set|convex]] subsets of a real vector space $X$ and let $\lambda\in\mathbb{R}$. Define the [[convex-analysis/set-operations-sum-scalar-multiple-difference|Minkowski sum and scalar multiple]]
$$
