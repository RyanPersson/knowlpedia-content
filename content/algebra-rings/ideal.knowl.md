...
title = "Ideal"
kind = "knowl"
summary = "An additive subgroup closed under multiplication by ring elements on one side (left or right)."
aliases = ["ideal"]
domains = ["algebra-rings"]
legacy_source_path = "algebra-rings/ideal.md"
+++

An **ideal** in a [[algebra-rings/ring|ring]] $R$ is an additive subgroup $I\le (R,+)$ such that it is stable under multiplication by elements of $R$ on one side:
