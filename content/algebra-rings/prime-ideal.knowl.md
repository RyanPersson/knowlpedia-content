...
Equivalently, $P$ is prime iff the [[algebra-rings/quotient-ring|quotient ring]] $R/P$ is an [[algebra-rings/integral-domain|integral domain]].

## Remarks

Prime ideals generalize prime numbers and underpin dimension theory, localization, and algebraic geometry.
