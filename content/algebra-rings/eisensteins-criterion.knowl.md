...
- \(p\nmid a_n\), and
- \(p^2\nmid a_0\),
then \(f\) is [[algebra-rings/irreducible-polynomial|irreducible]] in \(\mathrm{Frac}(R)[x]\), where \(\mathrm{Frac}(R)\) is the [[algebra-rings/fraction-field|fraction field]] of \(R\). If \(f\) is primitive, [[algebra-rings/gauss-lemma|Gauss's lemma]] also makes it irreducible in \(R[x]\).
