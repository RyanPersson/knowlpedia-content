+++
id = "algebra-rings/maximal-ideals-are-prime"
...
A standard proof uses the characterization that \(R/\mathfrak m\) is a field and hence an integral domain, and translates the domain property back to primeness via the [[algebra-rings/quotient-ring|quotient ring]].
