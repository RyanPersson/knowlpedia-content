...
\]
Self-adjoint operators ([[quantum-foundations/self-adjoint-operator-observable|Self Adjoint Operator Observable]]) play the role of observables, with real eigenvalues and an orthonormal eigenbasis.

For the general (possibly infinite-dimensional) notion, see [[linear-algebra/hilbert-space|Hilbert Space]].
