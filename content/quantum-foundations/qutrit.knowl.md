...
A **qutrit** is a quantum system whose state [[linear-algebra/hilbert-space|Hilbert space]] is three-dimensional over \(\mathbb C\), hence isomorphic after choosing an [[linear-algebra/orthonormal-basis|orthonormal basis]] to
\[
H\cong\mathbb C^3.
\]
...
In a basis \(\{|0\rangle,|1\rangle,|2\rangle\}\), a [[quantum-foundations/normalized-state-vector|normalized state vector]] is
\[
...
\]
a real [[nonassociative-algebra/jordan-algebra|Jordan algebra]] under \(A\circ B=\tfrac12(AB+BA)\); see the [[nonassociative-algebra/complex-qutrit-jordan-algebra|complex-qutrit Jordan algebra]].
