...
kind = "knowl"
summary = "Given S⊂R multiplicative, the module S^{-1}M obtained by inverting S in an R-module M."
aliases = ["localization-module", "Localization of a module"]
domains = ["algebra-commutative"]
legacy_source_path = "algebra-commutative/localization-module.md"
+++

Let $R$ be a [[algebra-rings/commutative-ring|commutative ring]], let $S\subseteq R$ be a [[algebra-commutative/multiplicative-set|multiplicative set]], and let $M$ be an $R$-module. The **localization of $M$ at $S$** is an $S^{-1}R$-module, denoted $S^{-1}M$, constructed so that every $s\in S$ acts invertibly on $S^{-1}M$.
