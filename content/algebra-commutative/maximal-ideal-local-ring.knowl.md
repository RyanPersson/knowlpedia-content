...
Let $R$ be a [[algebra-rings/commutative-ring|commutative ring]]. Write $R^\times$ for the group of units of $R$, and let
\[
...
This “units vs. maximal ideal” dichotomy is exactly what makes local arguments work; for instance, it is the setup needed in [[algebra-commutative/nakayama-lemma|Nakayama's lemma]].
