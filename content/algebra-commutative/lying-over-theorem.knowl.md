...
**Theorem (Lying over).**
Let \(A\subseteq B\) be an [[algebra-commutative/integral-extension|integral extension]] of [[algebra-rings/commutative-ring|commutative rings]]. For every prime ideal \(\mathfrak p\subseteq A\), there exists a prime ideal \(\mathfrak q\subseteq B\) such that
\[
