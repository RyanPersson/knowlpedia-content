...
For every $S$-module $N$, restriction of scalars along $f$ produces an $R$-module; this is [[algebra-commutative/restriction-of-scalars|restriction of scalars]]. Extension of scalars is left adjoint to restriction of scalars, meaning there is a natural bijection
\[
...
A particularly important special case is localization: if $S^{-1}R$ is the [[algebra-commutative/localization-ring|localization of R]] at a [[algebra-commutative/multiplicative-set|multiplicative set]] $S\subseteq R$, then extension of scalars along $R\to S^{-1}R$ recovers [[algebra-commutative/localization-module|localization of modules]]:
\[
