+++
id = "stat-mech/prop-mixed-fluctuation-identity"
title = "Mixed energy–number fluctuation identity (grand canonical)"
kind = "knowl"
summary = "In the grand canonical ensemble, derivatives with respect to μ or β yield covariances with N or with H−μN; in particular Cov(H,N) relates to mixed derivatives and to β-variation of ⟨N⟩."
aliases = ["prop-mixed-fluctuation-identity", "Mixed energy–number fluctuation identity (grand canonical)"]
domains = ["stat-mech"]
...
- Together with [[stat-mech/prop-grand-canonical-number-fluctuation|number fluctuation identity]], these yield a closed set of fluctuation/response relations for $(H,N)$.
