+++
id = "stat-mech/curie-weiss-model"
title = "Curie–Weiss model"
kind = "knowl"
summary = "Mean-field Ising ferromagnet with explicit variational free energy and self-consistency equation; exhibits spontaneous magnetization and a second-order phase transition."
aliases = ["curie-weiss-model", "Curie–Weiss model"]
domains = ["stat-mech"]
legacy_source_path = "stat-mech/curie-weiss-model.md"
+++

## Spins, Hamiltonian, and magnetization
The Curie–Weiss model is a fully connected mean-field analogue of the [[stat-mech-lattice/ising-model|Ising model]].
...
$$
This is a canonical example of [[stat-mech/mean-field-approximation|mean-field approximation]].

## Partition function reduced to a sum over magnetization
In the [[stat-mech/canonical-ensemble|canonical ensemble]], the partition function is
$$
...
$$
This is a concrete instance of a [[stat-mech/landau-free-energy-functional|Landau free energy functional]].
...
- For $T<T_c$ (equivalently $\beta J>1$), there are two symmetric nonzero minimizers $\pm m_*(T)$ solving
  ...
  m_*=\tanh(\beta J m_*).
  $$
This is the appearance of [[stat-mech-lattice/spontaneous-magnetization|spontaneous magnetization]] with magnetization as the [[stat-mech-lattice/order-parameter|order parameter]].

The critical temperature is
$$
T_c=\frac{J}{k_B}.
$$
This provides a clean mean-field example of a [[stat-mech-lattice/phase-transition-gibbs|phase transition]].
