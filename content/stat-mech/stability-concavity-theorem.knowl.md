+++
id = "stat-mech/stability-concavity-theorem"
title = "Stability implies concavity/convexity of thermodynamic potentials"
kind = "knowl"
summary = "Thermodynamic stability forces entropy to be concave in extensive variables (equivalently, energy is convex), yielding positivity of response functions."
aliases = ["stability-concavity-theorem", "Stability implies concavity/convexity of thermodynamic potentials"]
domains = ["stat-mech"]
...
- Standard response-function positivities follow (under appropriate regularity and choice of independent variables), e.g.
  - [[thermodynamics/heat-capacity-constant-volume|Heat capacity at constant volume]] satisfies $C_V\ge 0$ in stable regions (see also [[stat-mech/prop-cv-positivity-stability|C_V positivity from stability]]).
  - [[thermodynamics/isothermal-compressibility|Isothermal compressibility]] satisfies $\kappa_T\ge 0$ (see [[stat-mech/prop-compressibility-positivity|compressibility positivity]]).
- Stability restricts curvature of thermodynamic potentials obtained by [[convex-analysis/legendre-transform|Legendre transforms]] (e.g., convexity/concavity properties of [[thermodynamics/helmholtz-free-energy|Helmholtz free energy]] and [[thermodynamics/gibbs-free-energy|Gibbs free energy]]).
