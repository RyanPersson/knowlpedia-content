+++
id = "stat-mech/hydrodynamic-limit-theorem"
title = "Hydrodynamic Limit Theorem"
kind = "knowl"
summary = "Convergence of the empirical density of an interacting particle system (Markov dynamics) to a deterministic PDE under macroscopic scaling, exemplified by exclusion processes."
aliases = ["hydrodynamic-limit-theorem", "Hydrodynamic Limit Theorem"]
domains = ["stat-mech"]
...
- [[stat-mech/nonequilibrium-steady-state|nonequilibrium steady states]]
- [[stat-mech/donsker-varadhan-ldp|Donsker–Varadhan LDP]]

## Empirical density field

Let $(\eta_t)_{t\ge 0}$ be a conservative interacting particle system on a discrete torus $\mathbb{T}_N^d=(\mathbb{Z}/N\mathbb{Z})^d$ with Markov generator $L_N$ (described by a [[stat-mech/master-equation|master equation]] / [[stat-mech/markov-semigroup-continuous|Markov semigroup]]).
...
- **Connection to dynamical large deviations**: hydrodynamic limits are often paired with path-space LDPs; the time-averaged DV theory ([[stat-mech/donsker-varadhan-ldp|Donsker–Varadhan]]) is one cornerstone in this direction.
