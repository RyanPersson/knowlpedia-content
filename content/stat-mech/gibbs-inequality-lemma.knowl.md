+++
id = "stat-mech/gibbs-inequality-lemma"
title = "Gibbs' inequality (lemma)"
kind = "knowl"
summary = "Relative entropy (KL divergence) is nonnegative: D(P‖Q) ≥ 0, with equality iff P = Q (a.s.)."
aliases = ["gibbs-inequality-lemma", "Gibbs' inequality (lemma)"]
domains = ["stat-mech"]
legacy_source_path = "stat-mech/gibbs-inequality-lemma.md"
+++

## Definitions and notation

- [[probability/probability-measure|Probability measures]], [[probability/expectation|expectation]].
- [[probability/relative-entropy-kl-divergence|Relative entropy (KL divergence)]].
- [[probability/shannon-entropy|Shannon entropy]] (for the cross-entropy interpretation).
