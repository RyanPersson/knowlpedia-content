+++
id = "stat-mech/virial-expansion-convergence"
title = "Convergence of the Virial Expansion"
kind = "knowl"
summary = "Sufficient conditions (via cluster/Mayer expansions) guaranteeing analyticity of the pressure and a convergent virial series at low density (or small activity) for a classical gas."
aliases = ["virial-expansion-convergence", "Convergence of the Virial Expansion"]
domains = ["stat-mech"]
...
$$
and the thermodynamic pressure is the limit defining [[stat-mech/pressure-log-partition-density|pressure/log-partition density]].
...
with coefficients $B_n$ (the [[stat-mech/virial-coefficients|virial coefficients]]) determined combinatorially from the cluster integrals $b_n$ (see [[stat-mech/cluster-integrals-mayer|cluster integrals]]).
...
- **Uniform control via [[stat-mech/cluster-expansion-theorem|cluster expansion]]**: the same estimates typically imply exponential decay of correlations and uniqueness of the Gibbs state in the corresponding parameter region (high temperature / low density).
