+++
id = "stat-mech/rg-fixed-point"
title = "RG fixed point"
kind = "knowl"
summary = "A fixed point of a renormalization-group transformation and its linear stability data, which determine scaling and critical exponents."
aliases = ["rg-fixed-point", "RG fixed point"]
domains = ["stat-mech"]
legacy_source_path = "stat-mech/rg-fixed-point.md"
+++
...
- [[stat-mech-lattice/phase-transition-gibbs|phase transitions in Gibbs measures]]
