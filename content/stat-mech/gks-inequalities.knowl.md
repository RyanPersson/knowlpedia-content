+++
id = "stat-mech/gks-inequalities"
title = "GKS inequalities (Griffiths–Kelly–Sherman)"
kind = "knowl"
summary = "Ferromagnetic Ising correlation inequalities: nonnegativity of truncated correlations and monotonicity/convexity of the finite-volume pressure."
aliases = ["gks-inequalities", "GKS inequalities (Griffiths–Kelly–Sherman)"]
domains = ["stat-mech"]
...
Let $Z_\Lambda(J,h)$ be the [[stat-mech-lattice/partition-function-lattice|partition function]] and let $\langle\cdot\rangle_\Lambda$ denote expectation under the corresponding [[stat-mech-lattice/finite-volume-gibbs-measure|finite-volume Gibbs measure]].
...
(see [[stat-mech-lattice/pressure-lattice|pressure]]): derivatives of $\log Z_\Lambda$ with respect to fields/couplings are (truncated) correlations, so GKS II asserts nonnegativity of the corresponding second derivatives.
...
- Gibbs measure context: [[stat-mech-lattice/lattice-hamiltonian|lattice Hamiltonian]], [[stat-mech-lattice/finite-volume-gibbs-measure|finite-volume Gibbs measure]].
...
- The pair of inequalities above implies the [[stat-mech/griffiths-inequalities|Griffiths inequalities]] as a special case (many authors use the names interchangeably for the Ising ferromagnet).
- For increasing observables (not necessarily spin monomials), positivity of correlations can also be obtained from the [[stat-mech/fkg-inequality|FKG inequality]] when the measure is attractive.
