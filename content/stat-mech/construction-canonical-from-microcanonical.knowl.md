+++
id = "stat-mech/construction-canonical-from-microcanonical"
title = "Canonical ensemble from the microcanonical ensemble"
kind = "knowl"
summary = "Derives the canonical distribution for a subsystem coupled to a large reservoir, and relates Z(β) to the Laplace transform of the density of states."
aliases = ["construction-canonical-from-microcanonical", "Canonical ensemble from the microcanonical ensemble"]
domains = ["stat-mech"]
legacy_source_path = "stat-mech/construction-canonical-from-microcanonical.md"
+++
...
It complements the direct definition of the [[stat-mech/canonical-ensemble|canonical ensemble]] and connects to the microcanonical entropy built from the [[stat-mech/density-of-states|density of states]] (see [[thermodynamics/construction-microcanonical-entropy-density-of-states|microcanonical entropy from Ω(E)]]).
...
2. The composite system is described by the [[stat-mech/microcanonical-measure|microcanonical ensemble]] at energy $E_{\mathrm{tot}}$ (or in a thin [[stat-mech/microcanonical-shell|energy shell]]).
...
$$
as in [[stat-mech/boltzmann-entropy-microcanonical|Boltzmann microcanonical entropy]].
...
This identifies $\beta$ with the bath inverse temperature, matching [[thermodynamics/inverse-temperature-beta|thermodynamic inverse temperature]] and the microcanonical derivative rule in [[stat-mech/construction-temperature-from-entropy|constructing temperature from entropy]].
...
Normalizing over subsystem microstates produces the [[stat-mech/partition-function-canonical|canonical partition function]]:
$$
...
$$
so the canonical ensemble is a Laplace-transform reweighting of the microcanonical counting measure. This is the analytic backbone of the equivalence between ensembles in the [[thermodynamics/thermodynamic-limit|thermodynamic limit]].

Under suitable convexity/regularity assumptions, the dominant contribution to this integral at large system size is governed by a saddle point, and the canonical free energy becomes a Legendre-type transform of the microcanonical entropy density (compare [[convex-analysis/legendre-transform|Legendre transform]] and [[stat-mech/construction-legendre-s-to-f|Legendre construction from S to F]]).
...
- **Fluctuations:** canonical energy fluctuations of $S$ arise because $E_S$ is not fixed; they are encoded by derivatives of $\log Z_S$ (see [[stat-mech/construction-fluctuation-formulas-log-z|fluctuation formulas from log Z]]).
