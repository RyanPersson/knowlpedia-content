+++
id = "stat-mech/prop-grand-canonical-number-fluctuation"
title = "Grand-canonical number fluctuation identity"
kind = "knowl"
summary = "In the grand canonical ensemble, particle-number fluctuations equal the μ-derivative of the mean: Var(N) = (1/β) ∂⟨N⟩/∂μ = (1/β²) ∂² ln Ξ/∂μ²."
aliases = ["prop-grand-canonical-number-fluctuation", "Grand-canonical number fluctuation identity"]
domains = ["stat-mech"]
...
- This is the particle-number analog of canonical fluctuation identities (compare [[stat-mech/prop-fluctuation-response-equivalence|fluctuation–response equivalence]]).
