+++
id = "stat-mech/peierls-argument"
title = "Peierls argument"
kind = "knowl"
summary = "A contour estimate showing phase coexistence for the ferromagnetic Ising model on Z^d (d≥2) at sufficiently low temperature."
aliases = ["peierls-argument", "Peierls argument"]
domains = ["stat-mech"]
...
3. The plus and minus infinite-volume Gibbs states are distinct, so there are **at least two** [[stat-mech-lattice/infinite-volume-gibbs-measure|infinite-volume Gibbs measures]] at low temperature:
   $\mu^{+}\neq \mu^{-}$.

In particular, the model exhibits [[stat-mech-lattice/phase-transition-gibbs|phase coexistence / a phase transition]] for sufficiently large $\beta$.
...
- **Non-uniqueness of Gibbs measures:** there are multiple infinite-volume Gibbs states, typically extremal ones [[stat-mech-lattice/extremal-gibbs-measure|extremal Gibbs measures]] corresponding to $+$ and $-$ phases.
