+++
id = "stat-mech/dobrushin-uniqueness-theorem"
title = "Dobrushin uniqueness theorem"
kind = "knowl"
summary = "A quantitative small-dependence condition on single-site conditional distributions implies uniqueness of the infinite-volume Gibbs measure and strong mixing."
aliases = ["dobrushin-uniqueness-theorem", "Dobrushin uniqueness theorem"]
domains = ["stat-mech"]
...
- **Quasilocal specification:** $\gamma$ is a genuine Gibbs specification arising from some [[stat-mech-lattice/lattice-hamiltonian|lattice Hamiltonian]] (or at least satisfies the usual measurability/properness/consistency conditions).
