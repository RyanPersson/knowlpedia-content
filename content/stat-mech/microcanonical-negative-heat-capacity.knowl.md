+++
id = "stat-mech/microcanonical-negative-heat-capacity"
title = "Negative heat capacity in the microcanonical ensemble"
kind = "knowl"
summary = "In the microcanonical ensemble, heat capacity can be negative when the entropy has locally convex curvature; this cannot occur in the canonical ensemble and signals possible ensemble inequivalence."
aliases = ["microcanonical-negative-heat-capacity", "Negative heat capacity in the microcanonical ensemble"]
domains = ["stat-mech"]
legacy_source_path = "stat-mech/microcanonical-negative-heat-capacity.md"
+++

## Prerequisites and notation

- Microcanonical entropy density: [[stat-mech/microcanonical-entropy-density|microcanonical entropy density]]
- Canonical ensemble comparison: [[stat-mech/canonical-ensemble|canonical ensemble]]
- Thermodynamic stability language: [[thermodynamics/thermodynamic-stability|thermodynamic stability]], [[thermodynamics/heat-capacity-constant-volume|heat capacity]]
- Inequivalence context: [[stat-mech/ensemble-inequivalence-long-range|ensemble inequivalence for long-range systems]]
...
- In **nonadditive/long-range** systems, $s(u)$ may be nonconcave, producing $C_{\mathrm{mic}}<0$ and indicating [[stat-mech/ensemble-inequivalence-long-range|ensemble inequivalence]].
...
2. a convex-analytic “envelope” construction is needed to relate entropy to canonical free energy (see [[stat-mech/tfae-legendre-duality-entropy-free-energy|Legendre duality]]).
