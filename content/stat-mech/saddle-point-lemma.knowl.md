+++
id = "stat-mech/saddle-point-lemma"
title = "Saddle-Point (Laplace) Method in One Dimension"
kind = "knowl"
summary = "Refined asymptotics for integrals of exp(n f(x)) near a nondegenerate maximizer, giving Gaussian prefactors beyond the Laplace principle."
aliases = ["saddle-point-lemma", "Saddle-Point (Laplace) Method in One Dimension"]
domains = ["stat-mech"]
legacy_source_path = "stat-mech/saddle-point-lemma.md"
+++

This lemma refines the [[stat-mech/laplace-principle-lemma|Laplace principle]] by identifying the leading prefactor when the maximum is attained at a nondegenerate interior point.
