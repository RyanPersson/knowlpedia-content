+++
id = "stat-mech/peierls-bogoliubov-inequality"
title = "Peierls–Bogoliubov inequality"
kind = "knowl"
summary = "A variational upper bound on free energy: F(H) ≤ F(H0) + ⟨H−H0⟩_{H0}, equivalently a tangent-line bound for log Tr e^{A}."
aliases = ["peierls-bogoliubov-inequality", "Peierls–Bogoliubov inequality"]
domains = ["stat-mech"]
legacy_source_path = "stat-mech/peierls-bogoliubov-inequality.md"
+++

## Definitions and notation

- [[stat-mech-quantum/gibbs-state-quantum|Quantum Gibbs state]] and [[stat-mech-quantum/quantum-partition-function|quantum partition function]].
- [[stat-mech/free-energy-statistical|(Helmholtz) free energy in statistical mechanics]].
- [[stat-mech/golden-thompson-lemma|Golden–Thompson lemma]] (often used to establish convexity properties).
