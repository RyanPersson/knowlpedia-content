+++
id = "stat-mech/golden-thompson-inequality-stat-mech"
title = "Golden–Thompson inequality in statistical mechanics"
kind = "knowl"
summary = "Trace bound Tr(e^{A+B}) ≤ Tr(e^A e^B) and its standard application to quantum partition functions and free-energy bounds."
aliases = ["golden-thompson-inequality-stat-mech", "Golden–Thompson inequality in statistical mechanics"]
domains = ["stat-mech"]
...
$$
This is the [[quantum-foundations/golden-thompson-inequality|Golden–Thompson inequality]], emphasized here in the form most commonly used in quantum statistical mechanics.
...
- bounding interacting partition functions by splitting a Hamiltonian into “solvable + perturbation” pieces (useful alongside [[stat-mech/peierls-bogoliubov-inequality|Peierls–Bogoliubov]] bounds);
