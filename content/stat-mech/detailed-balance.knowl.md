+++
id = "stat-mech/detailed-balance"
title = "Detailed balance"
kind = "knowl"
summary = "Reversibility condition for Markov dynamics: equilibrium has no net probability currents and path probabilities match under time-reversal."
aliases = ["detailed-balance", "Detailed balance"]
domains = ["stat-mech"]
legacy_source_path = "stat-mech/detailed-balance.md"
+++
...
Prerequisites: [[probability/probability-measure|probability measure]], [[probability/expectation|expectation]], [[probability/relative-entropy-kl-divergence|relative entropy (KL)]], [[thermodynamics/thermodynamic-equilibrium|thermodynamic equilibrium]], [[stat-mech/markov-chain-discrete|Markov chain (discrete time)]], [[stat-mech/markov-semigroup-continuous|Markov semigroup (continuous time)]].
...
Out of equilibrium, stationary currents typically lead to positive entropy production. Detailed balance is the stochastic analogue of equilibrium, connecting naturally to [[thermodynamics/thermodynamic-entropy|thermodynamic entropy]] and to monotone decay of [[probability/relative-entropy-kl-divergence|relative entropy]] along dynamics defined by the [[stat-mech/master-equation|master equation]].
