+++
id = "stat-mech/cluster-expansion-theorem"
title = "Cluster expansion theorem (analyticity from convergent polymer expansions)"
kind = "knowl"
summary = "Abstract conditions ensuring convergence of cluster expansions for log-partition functions, yielding analyticity of pressure and decay of correlations at high temperature or low density."
aliases = ["cluster-expansion-theorem", "Cluster expansion theorem (analyticity from convergent polymer expansions)"]
domains = ["stat-mech"]
...
- quantitative bounds on [[stat-mech/correlation-function-two-point|correlations]] and a finite [[stat-mech/correlation-length|correlation length]].
...
$$
which matches the usual canonical setup (see [[stat-mech/partition-function-canonical|partition function]]).
...
- **High-temperature spin systems:** expansions around $\beta=0$ prove analyticity and uniqueness (useful for [[stat-mech/clt-high-temperature-gibbs|high-temperature CLT results]] and mixing estimates).
- **Low-density gases:** the expansion yields virial/cluster integral relations (compare [[stat-mech/cluster-integrals-mayer|Mayer cluster integrals]] and [[stat-mech/virial-coefficients|virial coefficients]]) and convergence criteria (see [[stat-mech/virial-expansion-convergence|virial expansion convergence]]).
- **Contours at low temperature:** contour expansions are a key input to [[stat-mech/pirogov-sinai-theory|Pirogov–Sinai theory]] for phase coexistence and surface tension.

## Prerequisites and connections (cross-links)
- Canonical thermodynamics link: [[stat-mech/canonical-ensemble|canonical ensemble]], [[stat-mech/free-energy-statistical|free energy]], [[stat-mech/pressure-log-partition-density|pressure as log-partition density]].
- Gibbs formalism: [[stat-mech-lattice/finite-volume-gibbs-measure|finite-volume Gibbs measures]], [[stat-mech-lattice/dlr-equation|DLR equations]].
- Phase transitions: [[stat-mech-lattice/phase-transition-gibbs|phase transitions (Gibbs)]], [[stat-mech-lattice/tfae-phase-transition-indicators|equivalent indicators of phase transitions]].
