+++
id = "stat-mech/prop-von-neumann-entropy-concave"
title = "Concavity of the von Neumann entropy"
kind = "knowl"
summary = "The von Neumann entropy is concave on density operators: mixing quantum states cannot decrease entropy."
aliases = ["prop-von-neumann-entropy-concave", "Concavity of the von Neumann entropy"]
domains = ["stat-mech"]
legacy_source_path = "stat-mech/prop-von-neumann-entropy-concave.md"
+++
