+++
id = "stat-mech/prop-quantum-relative-entropy-monotone"
title = "Monotonicity of quantum relative entropy"
kind = "knowl"
summary = "Quantum relative entropy cannot increase under completely positive trace-preserving maps (data processing inequality)."
aliases = ["prop-quantum-relative-entropy-monotone", "Monotonicity of quantum relative entropy"]
domains = ["stat-mech"]
legacy_source_path = "stat-mech/prop-quantum-relative-entropy-monotone.md"
+++

Quantum relative entropy is the operator-algebraic analogue of [[probability/relative-entropy-kl-divergence|Kullback–Leibler divergence]] for [[quantum-foundations/density-operator|density operators]].
...
- The inequality implies standard entropy consequences such as [[stat-mech/prop-von-neumann-entropy-concave|concavity of the von Neumann entropy]].
