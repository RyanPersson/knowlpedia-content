...
## Invariants
The [[linear-algebra/rank|rank]], [[linear-algebra/determinant|determinant]] (for square matrices), and [[linear-algebra/eigenvalue|eigenvalues]] are independent of the basis choice.
