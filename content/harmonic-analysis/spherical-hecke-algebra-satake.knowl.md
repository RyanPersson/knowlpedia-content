+++
id = "harmonic-analysis/spherical-hecke-algebra-satake"
...
prerequisites = ["algebra-fields-galois/nonarchimedean-local-field", "algebraic-geometry-foundations/unramified-reductive-group", "harmonic-analysis/maximal-compact-hyperspecial", "harmonic-analysis/haar-measure", "harmonic-analysis/convolution-on-locally-compact-group"]
...
If \(G\) is [[algebraic-geometry-foundations/split-reductive-group|split]] with
split [[algebraic-geometry-foundations/maximal-torus-weight-lattice|maximal torus]]
...
[[algebra-fields-galois/frobenius-unramified|Frobenius]] acts on the
[[langlands/langlands-dual-group|dual root datum]] and the
...
[[algebra-fields-galois/frobenius-unramified|Galois Frobenius
eigenvalues]].
...
[[algebra-modules/dual-lattice|dual lattice]]. Modern dual-group
