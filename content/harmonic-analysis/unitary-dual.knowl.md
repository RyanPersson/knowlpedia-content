...
representations]] of \(G\) on nonzero complex [[linear-algebra/hilbert-space|Hilbert spaces]]. The set carries the [[harmonic-analysis/fell-topology|Fell topology]],
whose definition is supplied by the linked entry after the underlying set
of representation classes has been constructed. This topology, not a generally
