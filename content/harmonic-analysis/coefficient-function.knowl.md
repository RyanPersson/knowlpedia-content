...
Diagonal coefficients record the positive kernel associated with a vector, while polarization recovers every \(c_{\xi,\eta}\) from diagonal coefficients. Conversely, the [[harmonic-analysis/gns-construction-positive-definite-function|GNS construction for positive-definite functions]] realizes every continuous positive-definite function as a diagonal coefficient of a cyclic unitary representation. This makes coefficients the scalar observables used to compare representations without choosing operator coordinates.
