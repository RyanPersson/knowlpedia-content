+++
id = "topology/topological-manifold"
...
The integer \(n\) is the manifold's dimension and is fixed on each [[topology/connected-component|connected component]]. No differentiability is assumed. A [[fiber-bundles/smooth-manifold|smooth manifold]] is a topological manifold equipped with charts whose transition maps are smooth, so every smooth manifold has an underlying topological manifold but not conversely.
