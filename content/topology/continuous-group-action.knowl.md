+++
id = "topology/continuous-group-action"
title = "Continuous group action"
kind = "knowl"
...
Equivalently, the action varies continuously both with the acting element and with the point. Every fixed \(g\in G\) then acts by a [[topology/homeomorphism|homeomorphism]], with inverse given by \(g^{-1}\). Continuity is separate from [[algebra-groups/faithful-action|faithfulness]]: continuity is topological regularity, while faithfulness says that only the identity acts trivially everywhere.
