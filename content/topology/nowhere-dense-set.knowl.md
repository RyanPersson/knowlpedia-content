...
Equivalently, \(A\) is nowhere dense if \(\overline{A}\) contains no nonempty [[topology/open-set|open set]].

## Remarks

Nowhere dense sets are the basic building blocks of [[topology/meager-set|meager sets]] in the [[topology/baire-space|Baire category]] viewpoint.
