...
Equivalently, \(R\) is residual if it contains a countable [[shared-foundations/intersection|intersection]] of sets that are both [[topology/open-set|open]] and [[topology/dense-set|dense]].

## Remarks

In a [[topology/baire-space|Baire space]], every residual set is dense.
