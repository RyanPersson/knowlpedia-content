...
- If \(q:X\to Y\) is a bijection, the quotient topology on \(Y\) agrees with the topology transported by \(q\), and \(q\) is automatically a [[topology/homeomorphism|homeomorphism]].
