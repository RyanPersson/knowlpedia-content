...
The set \(E^G\) is a subfield of \(E\). If \(E/F\) is a field extension and every automorphism in \(G\) fixes \(F\) pointwise, then
\[
F\subseteq E^G\subseteq E,
\]
so \(E^G\) is an [[algebra-fields-galois/intermediate-field|intermediate field]] of \(E/F\).
