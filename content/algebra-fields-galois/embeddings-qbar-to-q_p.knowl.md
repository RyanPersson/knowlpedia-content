+++
id = "algebra-fields-galois/embeddings-qbar-to-q_p"
...
prerequisites = ["algebra-fields-galois/decomposition-group", "algebra-fields-galois/galois-extension-and-group"]
...
and the
[[algebra-fields-galois/frobenius-unramified|Frobenius elements]] are
conjugate.
