+++
id = "functional-analysis/fredholm-determinant-trace-log"
...
Let \(H\) be a [[linear-algebra/hilbert-space|Hilbert space]] and let \(A\) be a [[functional-analysis/trace-class-operator|trace-class operator]] on \(H\). The **Fredholm determinant** of \(I+A\) is
\[
