...
The Ricci-form equation reduces to the nonlinear complex Monge–Ampère equation displayed in the core. Uniqueness follows from a maximum-principle argument. Existence requires a priori \(C^0\), Laplacian, and higher-order estimates along a continuity path; obtaining these estimates is the central achievement of Yau’s proof [Yau, §§2–4](https://doi.org/10.1002/cpa.3160310304).
