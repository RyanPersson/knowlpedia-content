...
\]
using the Poisson-bracket convention associated with \(\iota_{X_H}\omega=dH\). In particular, \(f\) is a [[differential-geometry/first-integral|first integral]] exactly when \(\{f,H\}=0\). See [Cannas da Silva, Lecture 18.4, Definitions 18.8 and 18.10](https://doi.org/10.1007/978-3-540-45330-7) for Hamiltonian and completely integrable systems.
