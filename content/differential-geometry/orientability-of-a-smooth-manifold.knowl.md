...
Equivalently, the top exterior-power [[fiber-bundles/line-bundle|line bundle]] \(\bigwedge^nT^*M\) is trivial. The equivalence between compatible local choices and a global top form uses [[fiber-bundles/partition-of-unity-subordinate-to-an-open-cover|smooth partitions of unity]] [Lee, chapter on orientations](https://doi.org/10.1007/978-1-4419-9982-5).
