...
\]
Thus smooth manifolds map contravariantly to their smooth-function algebras. Spaces of smooth sections of [[fiber-bundles/vector-bundle|vector bundles]] over \(M\) are naturally \(C^\infty(M)\)-modules, with multiplication defined pointwise.
