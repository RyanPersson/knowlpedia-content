...
\int_X\omega^n>0,
\]
so \([\omega]^n\neq0\). More generally, every power \([\omega]^k\) is nonzero for \(0\leq k\leq n\), as shown in [Demailly, Chapter VI, §4, Consequence 4.3](https://www-fourier.univ-grenoble-alpes.fr/~demailly/manuscripts/agbook.pdf).
