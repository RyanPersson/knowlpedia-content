...
\]
equals the codimension of \(T_pS+T_pT\) in \(T_pM\). Thus \(e=0\) precisely in the transverse case. Clean intersections and their excess directions are treated in [Abraham and Marsden, Chapter 3].
