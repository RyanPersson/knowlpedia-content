...
\]
This normal form explains both the image dimension \(r\) and the local fiber dimension \(m-r\). It is a theorem requiring local constancy of rank, not an alternative definition of the rank at a single point; see [Lee, Chapter 4].
