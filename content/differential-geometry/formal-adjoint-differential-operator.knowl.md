...
(P^\dagger)^\dagger=P.
\]
The formal adjoint has the same order as \(P\). Its principal symbol is the fiberwise adjoint of the principal symbol of \(P\), with the sign dictated by the chosen symbol convention. Formal adjoints and their role in elliptic theory are treated in [Wells, Chapter IV, “Elliptic Operator Theory”](https://doi.org/10.1007/978-0-387-73892-5).
