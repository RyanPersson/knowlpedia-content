...
\]
Every cohomology class is therefore uniquely assembled from primitive classes and powers of the Kähler class. The decomposition respects bidegree because \(L\) has type \((1,1)\); see [Voisin, §6.2, Theorem 6.25].
