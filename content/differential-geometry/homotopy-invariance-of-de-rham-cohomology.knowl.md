...
The theorem concerns smooth homotopies and ordinary de Rham cohomology. A continuous homotopy between smooth maps can be replaced by a smooth one under the standard smoothing theorem, but that extra step is not part of the chain-homotopy formula. Compact-support, relative, and boundary-condition variants require the homotopy operator to preserve the relevant support or restriction conditions [Tu, Chapter 17](https://doi.org/10.1007/978-1-4419-7400-6).
