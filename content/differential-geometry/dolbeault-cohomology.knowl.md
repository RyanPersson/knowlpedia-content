...
\]
where \(\Omega_X^p\) is the sheaf of holomorphic \(p\)-forms. The proof uses the Dolbeault lemma and the fine resolution by smooth \((p,\bullet)\)-forms [Wells, Chapter II, §3, Theorem 3.17](https://doi.org/10.1007/978-0-387-73892-5). This identifies an analytic quotient of differential forms with a sheaf-cohomological invariant.
...
\]
but such a direct-sum identification need not hold for a general complex manifold [Voisin, §6.1](https://doi.org/10.1017/CBO9780511615344).
