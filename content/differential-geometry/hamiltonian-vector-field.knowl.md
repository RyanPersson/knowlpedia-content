...
These properties and the defining convention appear in [Cannas da Silva, Lecture 18.1](https://doi.org/10.1007/978-3-540-45330-7).
...
**Warning.** Some authors define \(\iota_{X_H}\omega=-dH\). Changing that sign reverses \(X_H\) and changes the related coordinate and Poisson-bracket formulas. The plus-sign convention here agrees with [Abraham and Marsden, §3.3](https://doi.org/10.1090/chel/364) and with Cannas da Silva.
