...
\{f,g\}=X_g(f)
\]
under the convention \(\iota_{X_g}\omega=dg\). Therefore \(\{f,H\}\) is the rate of change of \(f\) along the [[differential-geometry/hamiltonian-flow|Hamiltonian flow]] of \(H\). On a connected symplectic manifold, the Poisson center consists exactly of the constant functions. These standard properties are developed in [Marsden and Ratiu, §10.1](https://doi.org/10.1007/978-0-387-21792-5).
