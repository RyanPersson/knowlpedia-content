...
*(*\alpha)=(-1)^{k(n-k)}\alpha.
\]
The star is a pointwise isometry, and \(*1=\operatorname{vol}_g\), while \(*\operatorname{vol}_g=1\). These identities follow directly in an oriented orthonormal coframe and characterize the signs used here. The construction and its role in the Laplacian are treated in [Morita, “Laplacian and harmonic forms”](https://doi.org/10.1090/mmono/201).
