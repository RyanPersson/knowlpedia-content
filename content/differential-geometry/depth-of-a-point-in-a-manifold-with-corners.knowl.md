...
\]
is a stratification by [[fiber-bundles/smooth-manifold|smooth manifolds]] without boundary, with \(\dim S^r(M)=n-r\). The depth-zero stratum is the interior. The closure of \(S^r(M)\) is the union of strata of depth at least \(r\).
