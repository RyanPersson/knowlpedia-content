...
\]
Robbin and Salamon prove that this agrees with the diagonal construction [Robbin–Salamon, Theorem 3.2](https://doi.org/10.1016/0040-9383%2893%2990052-W).
...
\]
If \(\Lambda_1(t)\equiv L_0\) is constant, it reduces to the path index relative to \(L_0\). When both endpoint pairs are transverse, it is integer-valued and invariant under homotopies that preserve endpoint transversality [Robbin–Salamon, Corollary 3.3](https://doi.org/10.1016/0040-9383%2893%2990052-W).
