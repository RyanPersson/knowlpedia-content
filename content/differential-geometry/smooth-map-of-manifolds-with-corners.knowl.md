...
Identity maps, composites, products, boundary inclusions, and projections are smooth in this sense; hence these maps form Joyce's category \(\mathbf{Man}^c\) [Joyce, Theorem 3.4](https://arxiv.org/abs/0910.3518). The inclusion \([0,\infty)\hookrightarrow\mathbb R\) is smooth because the target has no boundary.
