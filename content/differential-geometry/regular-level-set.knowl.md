...
\]
In these coordinates the level set is the coordinate slice on which the last \(n=\dim N\) coordinates are constant. This both gives the induced smooth structure and explains the tangent-space formula [Lee, Theorem 5.12](https://doi.org/10.1007/978-1-4419-9982-5).
