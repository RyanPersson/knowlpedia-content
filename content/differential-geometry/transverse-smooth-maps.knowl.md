...
\]
is an [[differential-geometry/embedded-submanifold|embedded submanifold]] of \(M\times N\) of dimension \(\dim M+\dim N-\dim P\). Its [[differential-geometry/tangent-space|tangent space]] consists of pairs \((v,w)\) satisfying \(df_x(v)=dg_y(w)\).
