...
\]
is the [[fiber-bundles/de-rham-cohomology-group|de Rham cohomology group]]. De Rham's theorem identifies it with singular cohomology with real coefficients, so a complex built from smooth forms recovers a topological invariant [Bott and Tu, Chapter I].
