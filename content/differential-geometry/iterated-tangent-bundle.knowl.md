...
For a vector space \(V\), translation gives \(TV\cong V\times V\) and \(T^rV\cong V^{2^r}\), although the canonical projections still distinguish the factors. For a general manifold no global product decomposition exists.
