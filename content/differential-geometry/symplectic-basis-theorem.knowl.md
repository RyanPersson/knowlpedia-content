...
\]
The restriction of \(\omega\) to \(H_1^\omega\) is again nondegenerate. Induction repeats the construction until the complement is zero. This is the alternating-form analogue of Gram–Schmidt orthogonalization [Cannas da Silva, §1.1](https://doi.org/10.1007/978-3-540-45330-7).
