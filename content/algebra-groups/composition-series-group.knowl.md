...
The groups \(G_i/G_{i-1}\) are called the **composition factors** of the series.

## Remarks

A major structural result, the [[algebra-groups/jordan-holder-theorem-groups|Jordan–Hölder theorem]], says that although a composition series is not unique, the multiset of isomorphism types of composition factors is unique up to permutation.
