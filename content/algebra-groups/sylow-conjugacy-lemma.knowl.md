+++
id = "algebra-groups/sylow-conjugacy-lemma"
...
In particular, any two Sylow \(p\)-subgroups are conjugate in \(G\) (take \(Q\) to be another Sylow \(p\)-subgroup), a key input toward [[algebra-groups/sylows-second-theorem|Sylow's second theorem]].
