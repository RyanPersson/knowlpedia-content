...
The normalizer is the largest subgroup \(K\le G\) such that \(H\) is a [[algebra-groups/normal-subgroup|normal subgroup]] of \(K\) (indeed, \(H\trianglelefteq N_G(H)\) by definition).
