...
title = "Free Group"
kind = "knowl"
summary = "The group generated by a set with no relations beyond the group axioms"
aliases = ["free-group", "Free Group"]
domains = ["algebra-groups"]
legacy_source_path = "algebra-groups/free-group.md"
+++

Let $S$ be a [[shared-foundations/set|set]]. A **free group on $S$** is a group $F(S)$ together with an injection $i:S\to F(S)$ such that the following universal property holds:
