+++
id = "algebra-groups/schreier-refinement-theorem"
title = "Schreier Refinement Theorem"
kind = "knowl"
summary = "Any two subnormal series admit equivalent refinements with isomorphic factors"
...
Schreier refinement is the main structural comparison tool for normal series. It is the standard input for [[algebra-groups/jordan-holder-theorem-groups|the Jordan–Hölder theorem]].
