+++
id = "algebra-groups/split-extension"
...
is **split** if there exists a [[algebra-groups/group-homomorphism|group homomorphism]] $s:Q\to E$ (a section) such that $\pi\circ s=\mathrm{id}_Q$. Equivalently, $E$ contains a subgroup isomorphic to $Q$ that maps isomorphically onto $Q$ under $\pi$.
