+++
id = "stat-mech-lattice/extremal-gibbs-measure"
title = "Extremal Gibbs measure"
kind = "knowl"
summary = "An infinite-volume Gibbs measure that is an extreme point of the convex set of Gibbs measures (equivalently, tail-trivial)."
aliases = ["extremal-gibbs-measure", "Extremal Gibbs measure"]
domains = ["stat-mech-lattice"]
legacy_source_path = "stat-mech-lattice/extremal-gibbs-measure.md"
+++

Fix a [[stat-mech-lattice/gibbs-specification|Gibbs specification]] $\gamma$ and let $\mathcal{G}(\gamma)$ denote the set of [[stat-mech-lattice/infinite-volume-gibbs-measure|infinite-volume Gibbs measures]] consistent with $\gamma$.
...
A standard equivalent characterization is **tail triviality**: if $\mathcal{T}$ is the tail [[measure-theory/sigma-algebra|σ-algebra]] (events depending only on spins arbitrarily far away),
$$
...
- **Ergodic behavior under symmetries (when applicable):** For [[stat-mech-lattice/translation-invariant-interaction|translation-invariant interactions]], many physically relevant extremal Gibbs measures are translation-ergodic (though extremality is defined relative to the Gibbs set, not relative to translations).
