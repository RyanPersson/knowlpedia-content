+++
id = "stat-mech-lattice/mixture-gibbs-measures"
title = "Mixtures of Gibbs measures"
kind = "knowl"
summary = "Convex combinations (or integrals) of infinite-volume Gibbs measures; these remain Gibbs and encode phase coexistence or random phase selection."
aliases = ["mixture-gibbs-measures", "Mixtures of Gibbs measures"]
domains = ["stat-mech-lattice"]
legacy_source_path = "stat-mech-lattice/mixture-gibbs-measures.md"
+++

Let $\gamma$ be a [[stat-mech-lattice/gibbs-specification|Gibbs specification]] and let $\mu_1,\mu_2 \in \mathcal{G}(\gamma)$ be [[stat-mech-lattice/infinite-volume-gibbs-measure|infinite-volume Gibbs measures]].
...
where $\rho$ is a [[probability/probability-measure|probability measure]] on the space of Gibbs measures.
...
- **Extremal decomposition:** Any Gibbs measure can be decomposed into [[stat-mech-lattice/extremal-gibbs-measure|extremal Gibbs measures]] (the extreme points of $\mathcal{G}(\gamma)$). In this sense, mixtures are the generic non-extremal equilibrium states.
