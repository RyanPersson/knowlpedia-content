+++
id = "stat-mech-lattice/external-field-coupling"
title = "External-field coupling"
kind = "knowl"
summary = "A term in the lattice Hamiltonian that couples spins to a prescribed field, biasing configurations and breaking symmetries."
aliases = ["external-field-coupling", "External-field coupling"]
domains = ["stat-mech-lattice"]
legacy_source_path = "stat-mech-lattice/external-field-coupling.md"
+++

In a lattice spin system with configuration $\sigma$ (see [[stat-mech-lattice/spin-configuration|spin configuration]]), an **external field coupling** is an additive contribution to the [[stat-mech-lattice/lattice-hamiltonian|lattice Hamiltonian]] of the form
$$
