+++
id = "stat-mech-lattice/ising-1d-no-phase-transition"
title = "1D Ising model: no phase transition at positive temperature"
kind = "knowl"
summary = "Transfer-matrix solution of the 1D Ising chain showing analyticity of the free energy for T>0, exponential decay of correlations, and absence of spontaneous magnetization."
aliases = ["ising-1d-no-phase-transition", "1D Ising model: no phase transition at positive temperature"]
domains = ["stat-mech-lattice"]
legacy_source_path = "stat-mech-lattice/ising-1d-no-phase-transition.md"
+++

## Prerequisites and notation

- Lattice spin system and Hamiltonian: [[stat-mech-lattice/lattice-hamiltonian|lattice Hamiltonian]]
...
- Canonical formalism: [[stat-mech/canonical-ensemble|canonical ensemble]], [[stat-mech/partition-function-canonical|canonical partition function]]
- Correlations: [[stat-mech/correlation-function-two-point|two-point correlation function]], [[stat-mech/correlation-length|correlation length]]
- Order parameter language: [[stat-mech-lattice/order-parameter|order parameter]], [[stat-mech-lattice/spontaneous-magnetization|spontaneous magnetization]]
...
$$
so there is no [[stat-mech-lattice/spontaneous-magnetization|spontaneous magnetization]] at positive temperature.
...
In 1D with finite-range interaction, the infinite-volume Gibbs state is unique for all $T>0$, matching the absence of multiple equilibrium states seen in [[stat-mech-lattice/phase-transition-gibbs|phase transitions as non-uniqueness of Gibbs measures]].
