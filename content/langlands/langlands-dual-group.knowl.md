+++
id = "langlands/langlands-dual-group"
...
prerequisites = ["algebraic-geometry-foundations/split-reductive-group", "algebraic-geometry-foundations/reductive-algebraic-group", "algebraic-geometry-foundations/maximal-torus-weight-lattice", "lie-groups/roots-weights-weyl", "algebraic-geometry-foundations/pinned-automorphisms"]
dependency_heuristic = "semantic-full-review-v1"
dependency_review_count = 1
+++

Let \(G\) be a [[algebraic-geometry-foundations/split-reductive-group|split]]
...
\(T\) and [[lie-groups/roots-weights-weyl|based root datum]]
...
A [[algebraic-geometry-foundations/pinned-automorphisms|pinning]] makes
...
Duality exchanges
[[algebraic-geometry-foundations/simply-connected-semisimple-group|simply
connected]] and
[[algebraic-geometry-foundations/root-vs-weight-lattice-isogeny|adjoint
...
[[algebra-modules/dual-lattice|dual-lattice construction]]. Its
