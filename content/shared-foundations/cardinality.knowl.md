+++
id = "shared-foundations/cardinality"
title = "Cardinality"
kind = "knowl"
...
Cardinality comparisons can be expressed using [[shared-foundations/injective-function|injections]] and [[shared-foundations/surjective-function|surjections]] between sets. A set is [[shared-foundations/countable-set|countable]] when its cardinality is at most that of the [[shared-foundations/natural-numbers|natural numbers]].
