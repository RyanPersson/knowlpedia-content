+++
id = "shared-foundations/well-ordering-principle"
...
This is exactly the statement that \((\mathbb{N},\le)\) is a [[shared-foundations/well-ordered-set|well-ordered set]]. It is equivalent in strength (over standard basic assumptions) to [[shared-foundations/mathematical-induction|mathematical induction]].
