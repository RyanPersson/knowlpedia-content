+++
id = "algebra-representation-theory/group-algebra-of-lattice"
...
[[algebraic-geometry-foundations/maximal-torus-weight-lattice|character lattice]]
\(X^*(T)=L\), then
...
For a [[algebraic-geometry-foundations/split-reductive-group|split group]] \(G\),
the [[harmonic-analysis/spherical-hecke-algebra-satake|normalized
...
The letter describes this using the group algebra of its [[algebra-modules/dual-lattice|dual lattice]].
