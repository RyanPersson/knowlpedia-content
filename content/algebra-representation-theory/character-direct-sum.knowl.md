+++
id = "algebra-representation-theory/character-direct-sum"
...
If \(V\) and \(W\) are representations, their direct sum \(V\oplus W\) is a [[algebra-modules/direct-sum-modules|direct sum]] representation with
\[
\rho_{V\oplus W}(g) \;=\;
\begin{pmatrix}
\rho_V(g) & 0\\
...
This identity is used constantly alongside [[algebra-representation-theory/character-orthogonality|character orthogonality]] to compute multiplicities of [[algebra-representation-theory/irreducible-representation|irreducible representations]] inside a given representation.
