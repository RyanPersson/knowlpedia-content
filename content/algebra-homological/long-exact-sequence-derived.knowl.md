+++
id = "algebra-homological/long-exact-sequence-derived"
...
Let $\mathcal A,\mathcal B$ be [[algebra-category-theory/abelian-category|abelian categories]] and let
\[
...
Then for every [[algebra-modules/short-exact-sequence|short exact sequence]]
\[
...
- Taking $F(-)=(-)\otimes_R N$ (right exact; see [[algebra-homological/tensor-right-exact|tensor is right exact]]) gives the [[algebra-homological/long-exact-sequence-tor|long exact sequence in Tor]].
- Taking $G(-)=\mathrm{Hom}_R(-,N)$ (left exact; see [[algebra-homological/hom-left-exact|Hom is left exact]]) gives the [[algebra-homological/long-exact-sequence-ext|long exact sequence in Ext]].
