+++
id = "algebra-homological/snake-lemma-corollary"
...
\]
be a **short exact sequence** of [[algebra-homological/chain-complex|chain complexes]], meaning that for each \(n\) the sequence
\[
0 \to A_n \to B_n \to C_n \to 0
\]
is exact in the sense of [[algebra-modules/exact-sequence-modules|exact sequences of modules]], and all differentials commute with the structure maps.

Then there are **connecting homomorphisms**
\[
\delta_n : H_n(C_\bullet) \longrightarrow H_{n-1}(A_\bullet)
\]
such that the sequence of [[algebra-homological/homology-module|homology modules]]
\[
