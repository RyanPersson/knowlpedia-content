+++
id = "algebra-homological/ext1-classifies-extensions"
...
Cross-links: [[algebra-homological/projective-resolution|projective resolutions]], [[algebra-homological/injective-resolution|injective resolutions]], [[algebra-homological/hom-left-exact|Hom is left exact]].

## Examples

### Example 1: \(\mathrm{Ext}^1_{\mathbb Z}(\mathbb Z/n\mathbb Z, A)\cong A/nA\)
Use the projective resolution from [[algebra-homological/projective-resolutions-exist|existence of projective resolutions]]:
\[
