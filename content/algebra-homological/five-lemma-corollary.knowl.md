+++
id = "algebra-homological/five-lemma-corollary"
...
This is an immediate corollary of the [[algebra-homological/five-lemma|five lemma]]: apply it to the corresponding length-5 exact sequences
\[
0 \to A' \to A \to A'' \to 0,\qquad 0 \to B' \to B \to B'' \to 0.
\]

Cross-links: [[algebra-homological/five-lemma|five lemma]], [[algebra-modules/exact-sequence-modules|exact sequences]], [[algebra-modules/short-exact-sequence|short exact sequences]].
