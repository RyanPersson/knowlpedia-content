...
- \(N \mapsto \operatorname{Hom}_R(M,N)\) and \(M\mapsto\operatorname{Hom}_R(M,N)\) are [[algebra-homological/hom-left-exact|left exact]] in their covariant and contravariant senses, respectively;
- \(M \mapsto M\otimes_R N\) is [[algebra-homological/tensor-right-exact|right exact]].
