...
Choose a [[algebra-homological/projective-resolution|projective resolution]] $P_\bullet \to M$, i.e.
\[
\cdots \to P_2 \xrightarrow{d_2} P_1 \xrightarrow{d_1} P_0 \to M \to 0
\]
with each $P_i$ projective. Apply the functor [[algebra-modules/hom-module|$\mathrm{Hom}_R(-,N)$]] to obtain a [[algebra-homological/cochain-complex|cochain complex]]
\[
...
\]
where $H^n(-)$ denotes [[algebra-homological/cohomology-module|cohomology]].
...
If $R\text{-Mod}$ has enough injectives, choose an [[algebra-homological/injective-resolution|injective resolution]] $N \to I^\bullet$ and set
\[
...
- Higher $\mathrm{Ext}^n$ can be viewed as higher obstructions and are the values of the [[algebra-homological/derived-functor|right derived functors]] of [[algebra-homological/hom-left-exact|$\mathrm{Hom}$ is left exact]].
