...
Equivalently, every factor representation \(\pi\) of \(A\) generates a [[operator-algebras/type-i-von-neumann-algebra|type I von Neumann algebra]] \(\pi(A)''\). Another characteristic consequence is that an irreducible representation is determined up to unitary equivalence by its kernel. Hence the spectrum of \(A\) maps bijectively to its primitive ideal space [Pedersen, Chapter 6](https://doi.org/10.1016/C2016-0-03431-9).
