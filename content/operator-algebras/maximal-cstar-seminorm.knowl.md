...
Every \(C^*\)-seminorm \(p\) on \(A\) is bounded above by \(\|\cdot\|_{\max}\): represent the \(C^*\)-completion of \(A/\ker p\) faithfully on a Hilbert space and compare norms. Some authors say “universal \(C^*\)-seminorm”; the adjective “maximal” emphasizes the supremum over all representations, not a chosen faithful one [Blackadar, section II.8](https://doi.org/10.1007/3-540-28517-2).
