...
\pi(A)'=\mathbb C I_H.
\]
It is also equivalent to every nonzero vector of \(H\) being cyclic, since the closure of \(\pi(A)\xi\) is an invariant subspace. These equivalences are standard forms of [[algebra-representation-theory/schurs-lemma|Schur's lemma]] for \(C^*\)-representations [Murphy, section 3.3].
