...
Having no nonzero [[operator-algebras/minimal-projection|minimal projections]] does not by itself imply type II: a diffuse [[operator-algebras/commutative-von-neumann-algebra|abelian von Neumann algebra]] also has no minimal projections, but it has nonzero [[operator-algebras/abelian-projection|abelian projections]] and is type I. The no-abelian-projection condition is what excludes this case. [[operator-algebras/type-iii-von-neumann-algebra|Type III algebras]] are also non-type-I, but, unlike type II algebras, they have no nonzero finite projections.
