...
\(W^*\)-algebra if and only if there is a [[linear-algebra/banach-space|Banach space]] \(E\) such that \(M\)
...
although a concrete realization still includes a choice of [[linear-algebra/hilbert-space|Hilbert space]] and
